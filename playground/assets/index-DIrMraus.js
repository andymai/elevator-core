...
)`},Ve=19,_t=16,Re=4,zn=(1+Ve)*Re,we=1,ve=41,ke=42,Hi=43;function U(e){return Array.from({length:Hi},(t,n)=>e(n))}const de=e=>e===we||e===ve||e===ke,Gi=[{name:"Morning rush",durationSec:90,ridersPerMin:40,originWeights:U(e=>e===0?20:e===we?2:e===ve?1.2:e===ke?.2:.1),destWeights:U(e=>e===0?0:e===we?.3:e===ve?.4:e===ke?.7:e===21?2:e>=38&&e<=40?.6:1)},{name:"Midday meetings",durationSec:90,ridersPerMin:18,originWeights:U(e=>de(e)?.5:1),destWeights:U(e=>de(e)?.5:1)},{name:"Lunch crowd",durationSec:75,ridersPerMin:22,originWeights:U(e=>e===21?4:de(e)?.25:1),destWeights:U(e=>e===21?5:de(e)?.25:1)},{name:"Evening commute",durationSec:90,ridersPerMin:36,originWeights:U(e=>e===0||e===we||e===21?.3:e===ve?.4:e===ke?1.2:1),destWeights:U(e=>e===0?20:e===we?1:e===ve?.6:e===ke?.2:.1)},{name:"Late night",durationSec:60,ridersPerMin:6,originWeights:U(e=>de(e)?1.5:.2),destWeights:U(e=>de(e)?1.5:.2)}];function Ui(){const e=[];e.push('        StopConfig(id: StopId(1),  name: "Lobby",      position: 0.0),'),e.push('        StopConfig(id: StopId(0),  name: "B1",         position: -4.0),');for(let a=1;a<=Ve;a++){const s=1+a,l=a*Re;e.push(`        StopConfig(id: StopId(${s.toString().padStart(2," ")}), name: "Floor ${a}",    position: ${l.toFixed(1)}),`)}e.push(`        StopConfig(id: StopId(21), name: "Sky Lobby",  position: ${zn.toFixed(1)}),`);for(let a=21;a<=20+_t;a++){const s=1+a,l=a*Re;e.push(`        StopConfig(id: StopId(${s}), name: "Floor ${a}",   position: ${l.toFixed(1)}),`)}e.push('        StopConfig(id: StopId(38), name: "Floor 37",   position: 148.0),'),e.push('        StopConfig(id: StopId(39), name: "Floor 38",   position: 152.0),'),e.push('        StopConfig(id: StopId(40), name: "Penthouse",  position: 156.0),'),e.push('        StopConfig(id: StopId(41), name: "B2",         position: -8.0),'),e.push('        StopConfig(id: StopId(42), name: "B3",         position: -12.0),');const t=[1,...Array.from({length:Ve},(a,s)=>2+s),21],n=[21,...Array.from({length:_t},(a,s)=>22+s)],i=[1,21,38,39,40],o=[1,0,41,42],r=a=>a.map(s=>`StopId(${s})`).join(", "),c=(a,s,l,f)=>`                ElevatorConfig(
                    id: ${a}, name: "${s}",
...
sim.setStrategy("etd");
`,Go={id:"manual",title:"Take the Wheel",brief:"Switch a car to manual control. Drive it yourself.",section:"events-manual",configRon:No,unlockedApi:["setStrategy","setServiceMode","setTargetVelocity"],seedRiders:[...$(10,{origin:0,destinations:[3,5,2,4],intervalTicks:70})],baseline:"self-autopilot",passFn:({delivered:e})=>e>=8,starFns:[({delivered:e,metrics:t})=>e>=8&&t.avg_wait_s<28,({delivered:e,metrics:t})=>e>=8&&t.avg_wait_s<22],starterCode:Ho,hints:["Manual mode is a tradeoff: you bypass dispatch heuristics but pay full cost for stops, doors, and direction reversals.","Setting target velocity to 0 doesn't park the car — it coasts until friction (none in this sim) or a brake stop. Use `setTargetVelocity(carRef, 0)` only when you've already arrived.",'3★ rewards a controller that can match the autopilot\'s average wait. Start with `setStrategy("etd")` (the starter code) and see how close manual gets you.'],failHint:({delivered:e})=>`Delivered ${e} of 8. If the car never moves, check that \`setServiceMode(carRef, "manual")\` ran before \`setTargetVelocity\` — direct drive only works in manual mode.`},Uo=`SimConfig(
    building: BuildingConfig(
        name: "Quest 10",
        stops: [
            StopConfig(id: StopId(0), name: "Lobby", position: 0.0),
