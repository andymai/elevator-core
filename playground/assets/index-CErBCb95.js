const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./editor.main-Du_WUfuU.js","./editor-CiRpT3TV.css"])))=>i.map(i=>d[i]);
...
)`,Jo={id:"choose",title:"Choose Wisely",brief:"Asymmetric morning rush. Pick the strategy that handles up-peak best.",section:"strategies",configRon:Qo,unlockedApi:["setStrategy"],seedRiders:[...B(36,{origin:0,destinations:[3,5,7,9,4,6,8,2,5,7,3,9],intervalTicks:20})],baseline:"nearest",passFn:({delivered:e})=>e>=30,starFns:[({delivered:e,metrics:t})=>e>=30&&t.avg_wait_s<22,({delivered:e,metrics:t})=>e>=30&&t.avg_wait_s<16],starterCode:`// Stage 5 — Choose Wisely
//
...
sim.setStrategy("etd");
`,Er={id:"sky-lobby",title:"Sky Lobby",brief:"Three cars, two zones, one sky lobby. Split duty for sub-22s.",section:"topology",configRon:Tr,unlockedApi:["setStrategy","assignLineToGroup","reassignElevatorToLine"],seedRiders:[...B(20,{origin:0,destinations:[2,3,4,1,3,2],intervalTicks:25}),...B(16,{origin:0,destinations:[5,6,7,8,5,7],startTick:120,intervalTicks:35})],baseline:"etd",passFn:({delivered:e})=>e>=30,starFns:[({delivered:e,metrics:t})=>e>=30&&t.avg_wait_s<28,({delivered:e,metrics:t})=>e>=30&&t.avg_wait_s<22],starterCode:Rr,hints:["`sim.assignLineToGroup(lineRef, groupId)` puts a line under a group's dispatcher; `groupId` is a plain integer (not a ref) and the call returns the active dispatcher's id. Two groups means two independent dispatch decisions.","`sim.reassignElevatorToLine(carRef, lineRef)` moves a car between lines without rebuilding the topology. Useful when a duty band is over- or under-loaded.","3★ requires sub-22s average wait. The Floater is the lever: park it on whichever side has the bigger queue and let the dedicated cars handle their bands."],failHint:({delivered:e})=>`Delivered ${e} of 30. Three cars share two zones — \`sim.assignLineToGroup(lineRef, groupId)\` lets each zone dispatch independently of the other.`},ne=[Uo,zo,Xo,Ko,Jo,tr,ir,sr,lr,ur,gr,yr,wr,Cr,Er];function Ir(e){return ne.find(t=>t.id===e)}function Ar(e){const t=ne.findIndex(n=>n.id===e);if(!(t<0))return ne[t+1]}function M(e,t){const n=document.getElementById(e);if(!n)throw new Error(`${t}: missing #${e}`);return n}function ot(e){for(;e.firstChild;)e.removeChild(e.firstChild)}const tt="quest:code:v1:",yi="quest:bestStars:v1:",Si=5e4;function Be(){try{return globalThis.localStorage??null}catch{return null}}function gn(e){const t=Be();if(!t)return null;try{const n=t.getItem(tt+e);if(n===null)return null;if(n.length>Si){try{t.removeItem(tt+e)}catch{}return null}return n}catch{return null}}function mn(e,t){if(t.length>Si)return;const n=Be();if(n)try{n.setItem(tt+e,t)}catch{}}function xr(e){const t=Be();if(t)try{t.removeItem(tt+e)}catch{}}function Fe(e){const t=Be();if(!t)return 0;let n;try{n=t.getItem(yi+e)}catch{return 0}if(n===null)return 0;const i=Number.parseInt(n,10);return!Number.isInteger(i)||i<0||i>3?0:i}function Mr(e,t){const n=Fe(e);if(t<=n)return;const i=Be();if(i)try{i.setItem(yi+e,String(t))}catch{}}const Pr={basics:"Basics",strategies:"Strategies","events-manual":"Events & Manual Control",topology:"Topology"},Lr=["basics","strategies","events-manual","topology"],vi=3;function Br(){return{root:M("quest-grid","quest-grid"),progress:M("quest-grid-progress","quest-grid"),sections:M("quest-grid-sections","quest-grid")}}function vt(e,t){ot(e.sections);let n=0;const i=ne.length*vi;for(const o of Lr){const r=ne.filter(l=>l.section===o);if(r.length===0)continue;const a=document.createElement("section");a.dataset.section=o;const s=document.createElement("h2");s.className="text-[10.5px] uppercase tracking-[0.08em] text-content-tertiary font-medium m-0 mb-2",s.textContent=Pr[o],a.appendChild(s);const c=document.createElement("div");c.className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2";for(const l of r){const u=Fe(l.id);n+=u,c.appendChild(Fr(l,u,t))}a.appendChild(c),e.sections.appendChild(a)}e.progress.textContent=`${n} / ${i}`}function Fr(e,t,n){const i=ne.findIndex(p=>p.id===e.id),o=String(i+1).padStart(2,"0"),r=document.createElement("button");r.type="button",r.dataset.stageId=e.id,r.className="group flex flex-col gap-1 p-3 text-left bg-surface-elevated border border-stroke-subtle rounded-md cursor-pointer transition-colors duration-fast hover:bg-surface-hover hover:border-stroke focus-visible:outline-none focus-visible:border-accent";const a=document.createElement("div");a.className="flex items-baseline justify-between gap-2";const s=document.createElement("span");s.className="text-content-tertiary text-[10.5px] tabular-nums font-medium",s.textContent=o,a.appendChild(s);const c=document.createElement("span");c.className="text-[12px] tracking-[0.18em] tabular-nums leading-none",c.classList.add(t>0?"text-accent":"text-content-disabled"),c.setAttribute("aria-label",t===0?"no stars earned":`${t} of 3 stars earned`),c.textContent="★".repeat(t)+"☆".repeat(vi-t),a.appendChild(c),r.appendChild(a);const l=document.createElement("div");l.className="text-content text-[13px] font-semibold tracking-[-0.01em]",l.textContent=e.title,r.appendChild(l);const u=document.createElement("div");return u.className="text-content-tertiary text-[11px] leading-snug overflow-hidden text-ellipsis [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]",u.textContent=e.brief,r.appendChild(u),r.addEventListener("click",()=>{n(e.id)}),r}const $r=75;async function bn(e,t,n,i){let o=n;for(;o<t.length;){const r=t[o];if(r===void 0||(r.atTick??0)>i)break;await e.spawnRider(r.origin,r.destination,r.weight??$r,r.patienceTicks),o+=1}return o}async function Dr(e,t,n={}){const i=n.maxTicks??1500,o=n.batchTicks??60,r=await Fo({configRon:e.configRon,strategy:"scan"});try{const a=[...e.seedRiders].sort((d,f)=>(d.atTick??0)-(f.atTick??0));let s=await bn(r,a,0,0);const c={unlockedApi:e.unlockedApi};n.timeoutMs!==void 0&&(c.timeoutMs=n.timeoutMs),await r.loadController(t,c);let l=null,u=0;const p=n.onSnapshot!==void 0;for(;u<i;){const d=i-u,f=Math.min(o,d),h=await r.tick(f,p?{wantVisuals:!0}:void 0);l=h.metrics,u=h.tick,s=await bn(r,a,s,u);const g=yn(l,u);if(n.onProgress)try{n.onProgress(g)}catch{}if(n.onSnapshot&&h.snapshot)try{n.onSnapshot(h.snapshot)}catch{}if(e.passFn(g))return Sn(e,g,!0)}if(l===null)throw new Error("runStage: maxTicks must be positive");return Sn(e,yn(l,u),!1)}finally{r.dispose()}}function yn(e,t){return{metrics:e,endTick:t,delivered:e.delivered,abandoned:e.abandoned}}function Sn(e,t,n){if(!n)return{passed:!1,stars:0,grade:t};let i=1;return e.starFns[0]?.(t)&&(i=2,e.starFns[1]?.(t)&&(i=3)),{passed:!0,stars:i,grade:t}}function Or(e){const t=`Tick ${e.endTick}`;if(e.delivered===0&&e.abandoned===0)return`${t} · waiting…`;const n=[t,`${e.delivered} delivered`];e.abandoned>0&&n.push(`${e.abandoned} abandoned`);const i=e.metrics.avg_wait_s;return e.delivered>0&&Number.isFinite(i)&&i>0&&n.push(`${i.toFixed(1)}s avg wait`),n.join(" · ")}const wi=[{name:"pushDestination",signature:"pushDestination(carRef, stopRef): void",description:"Append a stop to the back of the car's destination queue."},{name:"hallCalls",signature:"hallCalls(): { stop, direction }[]",description:"Pending hall calls — riders waiting at floors."},{name:"carCalls",signature:"carCalls(carRef): number[]",description:"Stop ids the riders inside the car have pressed."},{name:"drainEvents",signature:"drainEvents(): EventDto[]",description:"Take the events fired since the last drain (rider, elevator, door, …)."},{name:"setStrategy",signature:"setStrategy(name): boolean",description:"Swap to a built-in dispatch strategy by name (scan / look / nearest / etd / rsr)."},{name:"setStrategyJs",signature:"setStrategyJs(name, rank): boolean",description:"Register your own ranking function as the dispatcher. Return a number per (car, stop) pair; null excludes."},{name:"setServiceMode",signature:"setServiceMode(carRef, mode): void",description:"Switch a car between normal / manual / out-of-service modes."},{name:"setTargetVelocity",signature:"setTargetVelocity(carRef, vMps): void",description:"Drive a manual-mode car directly. Positive is up, negative is down."},{name:"holdDoor",signature:"holdDoor(carRef, ticks): void",description:"Hold the car's doors open for the given number of extra ticks. Calling again before the timer elapses extends the hold; cancelDoorHold clears it."},{name:"cancelDoorHold",signature:"cancelDoorHold(carRef): void",description:"Release a holdDoor; doors close on the next loading-complete tick."},{name:"emergencyStop",signature:"emergencyStop(carRef): void",description:"Halt a car immediately — no door cycle, no queue drain."},{name:"shortestRoute",signature:"shortestRoute(originStop, destStop): number[]",description:"Canonical route between two stops. First entry is origin, last is destination."},{name:"reroute",signature:"reroute(riderRef, newDestStop): void",description:"Send a rider to a new destination stop from wherever they currently are. Useful when their original destination is no longer reachable."},{name:"transferPoints",signature:"transferPoints(): number[]",description:"Stops that bridge two lines — useful when ranking trips that may need a transfer."},{name:"reachableStopsFrom",signature:"reachableStopsFrom(stop): number[]",description:"Every stop reachable without changing lines."},{name:"addStop",signature:"addStop(lineRef, name, position): bigint",description:"Create a new stop on a line. Returns the new stop's ref. Dispatch starts routing to it on the next tick."},{name:"addStopToLine",signature:"addStopToLine(stopRef, lineRef): void",description:"Register a stop on a line so dispatch routes to it."},{name:"assignLineToGroup",signature:"assignLineToGroup(lineRef, groupId): number",description:"Put a line under a group's dispatcher (groupId is a plain number). Two groups means two independent dispatch passes; the call returns the new dispatcher's id."},{name:"reassignElevatorToLine",signature:"reassignElevatorToLine(carRef, lineRef): void",description:"Move a car to a different line. Useful for duty-banding when one zone is busier."}];new Map(wi.map(e=>[e.name,e]));function ki(e){const t=new Set(e);return wi.filter(n=>t.has(n.name))}function Nr(){return{root:M("quest-api-panel","api-panel")}}function vn(e,t){ot(e.root);const n=ki(t.unlockedApi);if(n.length===0){const r=document.createElement("p");r.className="text-content-tertiary text-[11px] m-0",r.textContent="No methods unlocked at this stage.",e.root.appendChild(r);return}const i=document.createElement("p");i.className="m-0 text-[10.5px] uppercase tracking-[0.08em] text-content-tertiary font-medium",i.textContent=`Unlocked at this stage (${n.length})`,e.root.appendChild(i);const o=document.createElement("ul");o.className="m-0 mt-1.5 p-0 list-none flex flex-col gap-1 text-[12px] leading-snug max-h-[200px] overflow-y-auto";for(const r of n){const a=document.createElement("li");a.className="px-2 py-1 rounded-sm bg-surface-elevated border border-stroke-subtle/50";const s=document.createElement("code");s.className="block font-mono text-[12px] text-content",s.textContent=r.signature,a.appendChild(s);const c=document.createElement("p");c.className="m-0 mt-0.5 text-[11.5px] text-content-secondary",c.textContent=r.description,a.appendChild(c),o.appendChild(a)}e.root.appendChild(o)}function Wr(){return{root:M("quest-hints","hints-drawer"),count:M("quest-hints-count","hints-drawer"),list:M("quest-hints-list","hints-drawer")}}const wn="quest-hints-more";function kn(e,t){ot(e.list);for(const i of e.root.querySelectorAll(`.${wn}`))i.remove();const n=t.hints.length;if(n===0){e.count.textContent="(none for this stage)",e.root.removeAttribute("open");return}if(e.count.textContent=`(${n})`,t.hints.forEach((i,o)=>{const r=document.createElement("li");r.className="text-content-secondary leading-snug marker:text-content-tertiary",r.textContent=i,o>0&&(r.hidden=!0),e.list.appendChild(r)}),n>1){const i=document.createElement("button");i.type="button",i.className=`${wn} mt-1.5 ml-5 text-[11.5px] tracking-[0.01em] text-content-tertiary hover:text-content underline underline-offset-2 cursor-pointer bg-transparent border-0 p-0`,i.textContent=`Show ${n-1} more`,i.addEventListener("click",()=>{for(const o of e.list.querySelectorAll("li[hidden]"))o.hidden=!1;i.remove()}),e.root.appendChild(i)}e.root.removeAttribute("open")}function qr(e,t){return{activeStage:e,currentView:t,runLoop:{active:!1}}}function Hr(e,t){e.activeStage=t}function wt(e,t){e.currentView=t}function _n(e){e.runLoop.active=!1}function ke(e,t){return e.currentView==="stage"&&e.activeStage.id===t.id}function Gr(){return{root:M("quest-reference","reference-panel"),status:M("quest-reference-status","reference-panel"),code:M("quest-reference-code","reference-panel")}}function kt(e,t,n={}){const i=t.referenceSolution,o=Fe(t.id);if(!i||o===0){e.root.hidden=!0,e.root.removeAttribute("open");return}e.root.hidden=!1,e.status.textContent=o===3?"(mastered)":"(unlocked)",e.code.textContent=i,n.collapse!==!1&&e.root.removeAttribute("open")}function Ur(){const e="results-modal";return{root:M("quest-results-modal",e),title:M("quest-results-title",e),stars:M("quest-results-stars",e),detail:M("quest-results-detail",e),close:M("quest-results-close",e),retry:M("quest-results-retry",e),next:M("quest-results-next",e)}}function jr(e,t,n,i,o){t.passed?(e.title.textContent=t.stars===3?"Mastered!":"Passed",e.stars.textContent="★".repeat(t.stars)+"☆".repeat(3-t.stars)):(e.title.textContent="Did not pass",e.stars.textContent=""),e.detail.textContent=zr(t.grade,t.passed,i),e.retry.onclick=()=>{_t(e),n()},e.close.onclick=()=>{_t(e)};const r=o;r?(e.next.hidden=!1,e.next.onclick=()=>{_t(e),r()},e.retry.dataset.demoted="true"):(e.next.hidden=!0,e.next.onclick=null,delete e.retry.dataset.demoted),e.root.classList.add("show"),r?e.next.focus():e.close.focus()}function _t(e){e.root.classList.remove("show")}function zr(e,t,n){const i=`tick ${e.endTick}`,o=`${e.delivered} delivered, ${e.abandoned} abandoned`;if(t)return`${o} · finished by ${i}.`;if(n)try{const r=n(e);if(r)return`${o}. ${r}`}catch{}return`${o}. The pass condition wasn't met within the run budget.`}const Vr={pushDestination:"sim.pushDestination(0n, 2n);",hallCalls:"const calls = sim.hallCalls();",carCalls:"const inside = sim.carCalls(0n);",drainEvents:"const events = sim.drainEvents();",setStrategy:'sim.setStrategy("etd");',setStrategyJs:`sim.setStrategyJs("my-rank", (ctx) => {
  return Math.abs(ctx.carPosition - ctx.stopPosition);
});`,setServiceMode:'sim.setServiceMode(0n, "manual");',setTargetVelocity:"sim.setTargetVelocity(0n, 2.0);",holdDoor:"sim.holdDoor(0n, 60);",cancelDoorHold:"sim.cancelDoorHold(0n);",emergencyStop:"sim.emergencyStop(0n);",shortestRoute:"const route = sim.shortestRoute(0n, 4n);",reroute:"sim.reroute(/* riderRef */, /* newDestStop */ 4n);",transferPoints:"const transfers = sim.transferPoints();",reachableStopsFrom:"const reachable = sim.reachableStopsFrom(0n);",addStop:'const newStop = sim.addStop(/* lineRef */, "F6", 20.0);',addStopToLine:"sim.addStopToLine(/* stopRef */, /* lineRef */);",assignLineToGroup:"sim.assignLineToGroup(/* lineRef */, /* groupId */ 1);",reassignElevatorToLine:"sim.reassignElevatorToLine(0n, /* lineRef */);"};function Cn(e){return Vr[e]??`sim.${e}();`}function Xr(){return{root:M("quest-snippets","snippet-picker")}}function Tn(e,t,n){ot(e.root);const i=ki(t.unlockedApi);if(i.length!==0)for(const o of i){const r=document.createElement("button");r.type="button",r.className="inline-flex items-center px-2 py-0.5 rounded-sm bg-surface-elevated border border-stroke-subtle text-content text-[11.5px] font-mono cursor-pointer transition-colors duration-fast hover:bg-surface-hover hover:border-stroke",r.textContent=o.name,r.title=`Insert: ${Cn(o.name)}`,r.addEventListener("click",()=>{n.insertAtCursor(Cn(o.name))}),e.root.appendChild(r)}}const rt={idle:"#6b6b75",moving:"#f59e0b",repositioning:"#a78bfa","door-opening":"#fbbf24",loading:"#7dd3fc","door-closing":"#fbbf24",stopped:"#8b8c92",unknown:"#6b6b75"},Yr="#2a2a35",Kr="#a1a1aa",V='"Geist", ui-sans-serif, system-ui, -apple-system, "Segoe UI", sans-serif',Qr=["rgba(8, 10, 14, 0.55)","rgba(8, 10, 14, 0.55)","rgba(58, 34, 4, 0.55)","rgba(6, 30, 42, 0.55)"],Jr=["#3a3a45","#3a3a45","#8a5a1a","#2d5f70"],Zr="rgba(8, 10, 14, 0.55)",es="#3a3a45",ts=[1,1,.5,.42],ns=["LOW","HIGH","VIP","SERVICE"],is="#e6c56b",os="#9bd4c4",rs=["#a1a1aa","#a1a1aa","#d8a24a","#7cbdd8"],ss="#a1a1aa",as="#4a4a55",cs="#f59e0b",_i="#7dd3fc",Ci="#fda4af",Ct="#fafafa",Ti="#8b8c92",Ri="rgba(250, 250, 250, 0.95)",ls=260,Wt=3,ds=.05,Rn=["standard","briefcase","bag","short","tall"];function fe(e,t){let n=(e^2654435769)>>>0;return n=Math.imul(n^t,2246822507)>>>0,n=(n^n>>>13)>>>0,n=Math.imul(n,3266489909)>>>0,Rn[n%Rn.length]??"standard"}function ps(e,t){switch(e){case"short":{const n=t*.82;return{headR:n,shoulderW:n*2.3,waistW:n*1.6,footW:n*1.9,bodyH:n*5.2,neckGap:n*.2}}case"tall":return{headR:t*1.05,shoulderW:t*2.2,waistW:t*1.5,footW:t*1.9,bodyH:t*7.5,neckGap:t*.2};case"standard":case"briefcase":case"bag":default:return{headR:t,shoulderW:t*2.5,waistW:t*1.7,footW:t*2,bodyH:t*6,neckGap:t*.2}}}function Ei(e,t,n,i,o,r="standard"){const a=ps(r,i),c=n-.5,l=c-a.bodyH,u=l-a.neckGap-a.headR,p=a.bodyH*.08,d=c-a.headR*.8;if(e.fillStyle=o,e.beginPath(),e.moveTo(t-a.shoulderW/2,l+p),e.lineTo(t-a.shoulderW/2+p,l),e.lineTo(t+a.shoulderW/2-p,l),e.lineTo(t+a.shoulderW/2,l+p),e.lineTo(t+a.waistW/2,d),e.lineTo(t+a.footW/2,c),e.lineTo(t-a.footW/2,c),e.lineTo(t-a.waistW/2,d),e.closePath(),e.fill(),e.beginPath(),e.arc(t,u,a.headR,0,Math.PI*2),e.fill(),r==="briefcase"){const f=Math.max(1.6,a.headR*.9),h=t+a.waistW/2+f*.1,g=c-f-.5;e.fillRect(h,g,f,f);const m=f*.55;e.fillRect(h+(f-m)/2,g-1,m,1)}else if(r==="bag"){const f=Math.max(1.3,a.headR*.9),h=t-a.shoulderW/2-f*.35,g=l+a.bodyH*.35;e.beginPath(),e.arc(h,g,f,0,Math.PI*2),e.fill(),e.strokeStyle=o,e.lineWidth=.8,e.beginPath(),e.moveTo(h+f*.2,g-f*.8),e.lineTo(t+a.shoulderW/2-p,l+.5),e.stroke()}else if(r==="tall"){const f=a.headR*2.1,h=Math.max(1,a.headR*.45);e.fillRect(t-f/2,u-a.headR-h+.4,f,h)}}function us(e,t,n,i,o,r,a,s,c){const u=Math.max(1,Math.floor((o-14)/s.figureStride)),p=Math.min(r,u),d=-2;for(let f=0;f<p;f++){const h=t+d+i*f*s.figureStride,g=f+0,m=fe(c,g);Ei(e,h,n,s.figureHeadR,a,m)}if(r>p){e.fillStyle=Ti,e.font=`${s.fontSmall.toFixed(0)}px ui-sans-serif, system-ui, sans-serif`,e.textAlign="right",e.textBaseline="alphabetic";const f=t+d+i*p*s.figureStride;e.fillText(`+${r-p}`,f,n-1)}}function te(e,t,n,i,o,r){const a=Math.min(r,i/2,o/2);if(e.beginPath(),typeof e.roundRect=="function"){e.roundRect(t,n,i,o,a);return}e.moveTo(t+a,n),e.lineTo(t+i-a,n),e.quadraticCurveTo(t+i,n,t+i,n+a),e.lineTo(t+i,n+o-a),e.quadraticCurveTo(t+i,n+o,t+i-a,n+o),e.lineTo(t+a,n+o),e.quadraticCurveTo(t,n+o,t,n+o-a),e.lineTo(t,n+a),e.quadraticCurveTo(t,n,t+a,n),e.closePath()}function fs(e,t,n){if(e.measureText(t).width<=n)return t;const i="…";let o=0,r=t.length;for(;o<r;){const a=o+r+1>>1;e.measureText(t.slice(0,a)+i).width<=n?o=a:r=a-1}return o===0?i:t.slice(0,o)+i}function hs(e,t){for(const n of t){const i=n.width/2;e.fillStyle=n.fill,e.fillRect(n.cx-i,n.top,n.width,n.bottom-n.top)}e.lineWidth=1;for(const n of t){const i=n.width/2;e.strokeStyle=n.frame;const o=n.cx-i+.5,r=n.cx+i-.5;e.beginPath(),e.moveTo(o,n.top),e.lineTo(o,n.bottom),e.moveTo(r,n.top),e.lineTo(r,n.bottom),e.stroke()}}function gs(e,t,n){if(t.length===0)return;e.font=`600 ${n.fontSmall.toFixed(0)}px ${V}`,e.textBaseline="alphabetic",e.textAlign="center";const i=n.padTop-n.fontSmall*.5-2,o=i-n.fontSmall*.5-1,r=i+n.fontSmall*.5+1,a=Math.max(n.fontSmall+.5,o);for(const s of t){const c=s.top-3,l=c>o&&c-n.fontSmall<r;e.fillStyle=s.color,e.fillText(s.text,s.cx,l?a:c)}}function ms(e,t,n,i,o,r,a,s,c){e.font=`500 ${i.fontMain.toFixed(0)}px ${V}`,e.textBaseline="middle";const l=i.padX,u=i.padX+i.labelW,p=r-i.padX,d=i.shaftInnerW/2,f=Math.min(i.shaftInnerW*1.8,(p-u)/2);for(let h=0;h<t.length;h++){const g=t[h];if(g===void 0)continue;const m=n(g.y),k=t[h+1],w=k!==void 0?n(k.y):s;if(e.strokeStyle=Yr,e.lineWidth=c?2:1,e.beginPath(),c)for(const y of o)e.moveTo(y-f,m+.5),e.lineTo(y+f,m+.5);else{let y=u;for(const v of o){const C=v-d,b=v+d;C>y&&(e.moveTo(y,m+.5),e.lineTo(C,m+.5)),y=b}y<p&&(e.moveTo(y,m+.5),e.lineTo(p,m+.5))}e.stroke();for(let y=0;y<o.length;y++){const v=o[y];if(v===void 0)continue;const C=a.has(y,g.entity_id);e.strokeStyle=C?cs:as,e.lineWidth=C?1.4:1,e.beginPath(),e.moveTo(v-d-2,m+.5),e.lineTo(v-d,m+.5),e.moveTo(v+d,m+.5),e.lineTo(v+d+2,m+.5),e.stroke()}const _=c?m:(m+w)/2;e.fillStyle=Kr,e.textAlign="right",e.fillText(fs(e,g.name,i.labelW-4),l+i.labelW-4,_)}}function bs(e,t,n,i,o,r){for(const a of t.stops){if(a.waiting_by_line.length===0)continue;const s=r.get(a.entity_id);if(s===void 0||s.size===0)continue;const c=n(a.y),l=a.waiting_up>=a.waiting_down?_i:Ci;for(const u of a.waiting_by_line){if(u.count===0)continue;const p=s.get(u.line);if(p===void 0)continue;const d=o.get(p);if(d===void 0)continue;const f=d.end-d.start;f<=i.figureStride||us(e,d.end-2,c,-1,f,u.count,l,i,a.entity_id)}}}const Tt=new Map;function Kt(e){const t=Tt.get(e);if(t!==void 0)return t;const n=e.match(/^#?([0-9a-f]{6})$/i);if(!n||n[1]===void 0)return Tt.set(e,null),null;const i=parseInt(n[1],16),o=[i>>16&255,i>>8&255,i&255];return Tt.set(e,o),o}function qt(e,t){const n=Kt(e);if(n===null)return e;const[i,o,r]=n,a=s=>t>=0?Math.round(s+(255-s)*t):Math.round(s*(1+t));return`rgb(${a(i)}, ${a(o)}, ${a(r)})`}function Qt(e,t){const n=Kt(e);if(n===null)return e;const[i,o,r]=n;return`rgba(${i}, ${o}, ${r}, ${t})`}function Ue(e,t){if(Kt(e)!==null&&e.startsWith("#")){const n=Math.round(Math.max(0,Math.min(1,t))*255);return`${e}${n.toString(16).padStart(2,"0")}`}return Qt(e,t)}function ys(e,t,n,i,o){const r=(e+n)/2,a=(t+i)/2,s=n-e,c=i-t,l=Math.max(Math.hypot(s,c),1),u=-c/l,p=s/l,d=Math.min(l*.25,22),f=r+u*d,h=a+p*d,g=1-o;return[g*g*e+2*g*o*f+o*o*n,g*g*t+2*g*o*h+o*o*i]}function Ii(e){let r=e;for(let s=0;s<3;s++){const c=1-r,l=3*c*c*r*.2+3*c*r*r*.2+r*r*r,u=3*c*c*.2+6*c*r*(.2-.2)+3*r*r*(1-.2);if(u===0)break;r-=(l-e)/u,r=Math.max(0,Math.min(1,r))}const a=1-r;return 3*a*a*r*.6+3*a*r*r*1+r*r*r}function Ss(e,t,n,i,o,r,a,s,c,l=!1){const u=i*.22,p=(o-4)/10.5,d=Math.max(1.2,Math.min(s.figureHeadR,u,p)),f=s.figureStride*(d/s.figureHeadR),h=3,g=2,m=i-h*2,w=Math.max(1,Math.floor((m-16)/f)),_=Math.min(r,w),y=_*f,v=t-y/2+f/2,C=n-g;for(let b=0;b<_;b++){const T=c?.[b]??fe(0,b);Ei(e,v+b*f,C,d,a,T)}if(r>_){const b=`+${r-_}`,T=Math.max(8,s.fontSmall-1);e.font=`700 ${T.toFixed(1)}px ${V}`,e.textAlign="right",e.textBaseline="middle";const I=e.measureText(b).width,E=3,R=1.5,A=Math.ceil(I+E*2),P=Math.ceil(T+R*2),D=t+i/2-2,O=n-o+2,N=D-A;e.fillStyle="rgba(15, 15, 18, 0.85)",te(e,N,O,A,P,2),e.fill(),e.fillStyle="#fafafa",e.fillText(b,D-E,O+P/2)}if(l){const b=Math.max(10,Math.min(o*.7,i*.55));e.font=`800 ${b.toFixed(0)}px ${V}`,e.textAlign="center",e.textBaseline="middle";const T=n-o/2;e.fillStyle="rgba(15, 15, 18, 0.6)",e.fillText("F",t,T+1),e.fillStyle="rgba(239, 68, 68, 0.92)",e.fillText("F",t,T)}}const vs=Array.from({length:Wt},(e,t)=>Qt(rt.moving,.18*(1-t/Wt))),En=Object.fromEntries(Object.entries(rt).map(([e,t])=>[e,qt(t,.18)]));function ws(e,t,n,i,o,r,a){const s=Math.max(2,r.figureHeadR*.9);for(const c of t.cars){if(c.target===void 0)continue;const l=a.get(c.target);if(l===void 0)continue;const u=t.stops[l];if(u===void 0)continue;const p=n.get(c.id);if(p===void 0)continue;const d=o(u.y)-r.carH/2,f=o(c.y)-r.carH/2;Math.abs(f-d)<.5||(e.strokeStyle="rgba(250, 250, 250, 0.5)",e.lineWidth=1,e.beginPath(),e.moveTo(p,f),e.lineTo(p,d),e.stroke(),e.fillStyle=Ri,e.beginPath(),e.arc(p,d,s,0,Math.PI*2),e.fill())}}function ks(e,t,n,i,o,r){if(t.phase!=="moving"||Math.abs(t.v)<.1)return;const a=i/2;for(let s=1;s<=Wt;s++){const c=r(t.y-t.v*ds*s);e.fillStyle=vs[s-1]??"rgba(107, 107, 117, 0.06)",e.fillRect(n-a,c-o,i,o)}}function _s(e,t,n,i,o,r,a,s,c){const l=a(t.y),u=l-o,p=i/2,d=rt[t.phase]??"#6b6b75";e.fillStyle=d,e.fillRect(n-p,u,i,o),e.strokeStyle="rgba(10, 12, 16, 0.9)",e.lineWidth=1,e.strokeRect(n-p+.5,u+.5,i-1,o-1),e.strokeStyle=En[t.phase]??En.unknown,e.beginPath(),e.moveTo(n-p+1,u+1.5),e.lineTo(n+p-1,u+1.5),e.stroke();const f=t.capacity>0&&t.load>=t.capacity*.95;(t.riders>0||f)&&Ss(e,n,l,i,o,t.riders,r,s,c,f)}const In=6,Cs=3,Rt=4,he=3,ue=2.5,K=2,Ts=12,Rs="rgba(37, 37, 48, 0.80)",Es="#ECECEE",An=3,xn=.3,Is=140,Mn=.85;function As(e,t,n,i,o,r,a,s){const c=a.fontSmall+.5;e.font=`500 ${c}px ${V}`,e.textBaseline="middle",Pn(e,"-0.1px");const l=performance.now(),u=Ue(t,.45),p=Ue(t,.5),d=Ue(t,.75),f=[];for(const[g,m]of i){const k=n.get(g);if(k===void 0)continue;const w=o.get(g);if(w===void 0)continue;const _=r(k.y),y=_-a.carH,v=Math.max(1,m.expiresAt-m.bornAt),C=m.expiresAt-l,b=C>v*xn?1:Math.max(0,C/(v*xn)),T=Math.max(0,l-m.bornAt),I=Math.min(1,T/Is),E=b*I;if(E<=0)continue;const R=e.measureText(m.glyph).width,A=R+An+e.measureText(m.text).width+In*2,P=c+Cs*2+2,D=y-K-ue-P,O=_+K+ue+P>s,N=D<2&&!O?"below":"above",be=N==="above"?y-K-ue-P:_+K+ue;let H=w-A/2;const ye=2,Se=s-A-2;H<ye&&(H=ye),H>Se&&(H=Se),f.push({bubble:m,glyphW:R,alpha:E,cx:w,carTop:y,carBottom:_,bubbleW:A,bubbleH:P,side:N,bx:H,by:be,entrance:I})}const h=(g,m)=>!(g.bx+g.bubbleW<=m.bx||m.bx+m.bubbleW<=g.bx||g.by+g.bubbleH<=m.by||m.by+m.bubbleH<=g.by);for(let g=1;g<f.length;g++){const m=f[g];if(m===void 0)continue;let k=!1;for(let C=0;C<g;C++){const b=f[C];if(b!==void 0&&h(m,b)){k=!0;break}}if(!k)continue;const w=m.side==="above"?"below":"above",_=w==="above"?m.carTop-K-ue-m.bubbleH:m.carBottom+K+ue,y={...m,side:w,by:_};let v=!0;for(let C=0;C<g;C++){const b=f[C];if(b!==void 0&&h(y,b)){v=!1;break}}v&&(f[g]=y)}for(const g of f){const{bubble:m,glyphW:k,alpha:w,cx:_,carTop:y,carBottom:v,bubbleW:C,bubbleH:b,side:T,bx:I,by:E,entrance:R}=g,A=T==="above"?y-K:v+K,P=Math.min(Math.max(_,I+Rt+he/2),I+C-Rt-he/2),D=Ii(R),O=Mn+(1-Mn)*D;e.save(),e.globalAlpha=w,e.translate(P,A),e.scale(O,O),e.translate(-P,-A),xs(e,I,E,C,b,Rt,T,P,A),e.shadowColor=p,e.shadowBlur=Ts,e.fillStyle=Rs,e.fill(),e.shadowBlur=0,e.shadowColor="transparent",e.strokeStyle=u,e.lineWidth=1,e.stroke();const N=E+b/2,be=I+In;e.textAlign="left",e.fillStyle=d,e.fillText(m.glyph,be,N),e.fillStyle=Es,e.fillText(m.text,be+k+An,N),e.restore()}Pn(e,"0px")}function xs(e,t,n,i,o,r,a,s,c){const l=Math.min(r,i/2,o/2);e.beginPath(),e.moveTo(t+l,n),a==="below"&&(e.lineTo(s-he/2,n),e.lineTo(s,c),e.lineTo(s+he/2,n)),e.lineTo(t+i-l,n),e.arcTo(t+i,n,t+i,n+l,l),e.lineTo(t+i,n+o-l),e.arcTo(t+i,n+o,t+i-l,n+o,l),a==="above"&&(e.lineTo(s+he/2,n+o),e.lineTo(s,c),e.lineTo(s-he/2,n+o)),e.lineTo(t+l,n+o),e.arcTo(t,n+o,t,n+o-l,l),e.lineTo(t,n+l),e.arcTo(t,n,t+l,n,l),e.closePath()}function Pn(e,t){e.letterSpacing=t}function Ln(e){return e<12e3?"troposphere":e<5e4?"stratosphere":e<8e4?"mesosphere":e<7e5?"thermosphere":e>=354e5&&e<=362e5?"geostationary":"exosphere"}function Ms(e){const t=[];for(let n=3;n<=8;n++){const i=10**n;if(i>e)break;t.push({altitudeM:i,label:st(i)})}return t}function st(e){if(e<1e3)return`${Math.round(e)} m`;const t=e/1e3;return t<10?`${t.toFixed(1)} km`:t<1e3?`${t.toFixed(0)} km`:`${t.toLocaleString("en-US",{maximumFractionDigits:0})} km`}function Ai(e){const t=Math.abs(e);return t<1?`${t.toFixed(2)} m/s`:t<100?`${t.toFixed(0)} m/s`:`${(t*3.6).toFixed(0)} km/h`}function Bn(e,t,n){const i=Math.abs(e);if(i<.5)return"idle";const o=i-Math.abs(t);return i>=n*.95&&Math.abs(o)<n*.005?"cruise":o>0?"accel":o<0?"decel":"cruise"}function Ps(e){if(!Number.isFinite(e)||e<=0)return"—";if(e<60)return`${Math.round(e)} s`;if(e<3600){const i=Math.floor(e/60),o=Math.round(e%60);return o===0?`${i}m`:`${i}m ${o}s`}const t=Math.floor(e/3600),n=Math.round(e%3600/60);return n===0?`${t}h`:`${t}h ${n}m`}function Ls(e,t,n,i,o,r){const a=Math.abs(t-e);if(a<.001)return 0;const s=Math.abs(n);if(s*s/(2*r)>=a)return s>0?s/r:0;const l=Math.max(0,(i-s)/o),u=s*l+.5*o*l*l,p=i/r,d=i*i/(2*r);if(u+d>=a){const h=(2*o*r*a+r*s*s)/(o+r),g=Math.sqrt(Math.max(h,s*s));return(g-s)/o+g/r}const f=a-u-d;return l+f/Math.max(i,.001)+p}const xi={accel:"accel",cruise:"cruise",decel:"decel",idle:"idle"},nt={accel:"#7dd3fc",cruise:"#fbbf24",decel:"#fda4af",idle:"#6b6b75"};function Bs(e,t,n,i,o,r){const a=o/2,s=i-r/2,c=rt[t.phase]??"#6b6b75",l=e.createLinearGradient(n,s,n,s+r);l.addColorStop(0,qt(c,.14)),l.addColorStop(1,qt(c,-.18)),e.fillStyle=l,te(e,n-a,s,o,r,Math.min(3,r*.16)),e.fill(),e.strokeStyle="rgba(10, 12, 16, 0.9)",e.lineWidth=1,e.stroke(),e.fillStyle="rgba(245, 158, 11, 0.55)",e.fillRect(n-a+2,s+r*.36,o-4,Math.max(1.5,r*.1))}function Fs(e,t,n,i,o){if(t.length===0)return;const r=7,a=4,s=o.fontSmall+2,c=n/2+8;e.font=`600 ${(o.fontSmall+.5).toFixed(1)}px ${V}`;const l=(d,f)=>{const h=[d.carName,st(d.altitudeM),Ai(d.velocity),`${xi[d.phase]} · ${d.layer}`];let g=0;for(const y of h)g=Math.max(g,e.measureText(y).width);const m=g+r*2,k=h.length*s+a*2;let w=f==="right"?d.cx+c:d.cx-c-m;w=Math.max(2,Math.min(i-m-2,w));const _=d.cy-k/2;return{hud:d,lines:h,bx:w,by:_,bubbleW:m,bubbleH:k,side:f}},u=(d,f)=>!(d.bx+d.bubbleW<=f.bx||f.bx+f.bubbleW<=d.bx||d.by+d.bubbleH<=f.by||f.by+f.bubbleH<=d.by),p=[];t.forEach((d,f)=>{let h=l(d,f%2===0?"right":"left");if(p.some(g=>u(h,g))){const g=l(d,h.side==="right"?"left":"right");if(p.every(m=>!u(g,m)))h=g;else{const m=Math.max(...p.map(k=>k.by+k.bubbleH));h={...h,by:m+4}}}p.push(h)});for(const d of p){e.save(),e.fillStyle="rgba(37, 37, 48, 0.92)",te(e,d.bx,d.by,d.bubbleW,d.bubbleH,4),e.fill(),e.fillStyle=nt[d.hud.phase],e.fillRect(d.bx,d.by,2,d.bubbleH),e.strokeStyle="#2a2a35",e.lineWidth=1,te(e,d.bx,d.by,d.bubbleW,d.bubbleH,4),e.stroke(),e.textBaseline="middle",e.textAlign="left";for(let f=0;f<d.lines.length;f++){const h=d.by+a+s*f+s/2,g=d.lines[f]??"";e.fillStyle=f===0||f===3?nt[d.hud.phase]:"rgba(240, 244, 252, 0.95)",e.fillText(g,d.bx+r,h)}e.restore()}}function $s(e,t,n,i,o,r){if(t.length===0)return;const a=18,s=10,c=6,l=5,u=r.fontSmall+2.5,d=c*2+5*u,f=a+c+(d+l)*t.length;e.save();const h=e.createLinearGradient(n,o,n,o+f);h.addColorStop(0,"#252530"),h.addColorStop(1,"#1a1a1f"),e.fillStyle=h,te(e,n,o,i,f,8),e.fill(),e.strokeStyle="#2a2a35",e.lineWidth=1,te(e,n,o,i,f,8),e.stroke(),e.strokeStyle="rgba(255,255,255,0.025)",e.beginPath(),e.moveTo(n+8,o+1),e.lineTo(n+i-8,o+1),e.stroke(),e.fillStyle="#a1a1aa",e.font=`600 ${(r.fontSmall-.5).toFixed(0)}px ${V}`,e.textAlign="left",e.textBaseline="middle",e.fillText("CLIMBERS",n+s,o+a/2+2);let g=o+a+c;for(const m of t){e.fillStyle="rgba(15, 15, 18, 0.55)",te(e,n+6,g,i-12,d,5),e.fill(),e.fillStyle=nt[m.phase],e.fillRect(n+6,g,2,d);const k=n+s+4,w=n+i-s;let _=g+c+u/2;e.font=`600 ${(r.fontSmall+.5).toFixed(1)}px ${V}`,e.fillStyle="#fafafa",e.textAlign="left",e.fillText(m.carName,k,_),e.textAlign="right",e.fillStyle=nt[m.phase],e.font=`600 ${(r.fontSmall-1).toFixed(1)}px ${V}`,e.fillText(xi[m.phase].toUpperCase(),w,_);const y=m.etaSeconds!==void 0&&Number.isFinite(m.etaSeconds)?Ps(m.etaSeconds):"—",v=[["Altitude",st(m.altitudeM)],["Velocity",Ai(m.velocity)],["Dest",m.destinationName??"—"],["ETA",y]];e.font=`500 ${(r.fontSmall-.5).toFixed(1)}px ${V}`;for(const[C,b]of v)_+=u,e.textAlign="left",e.fillStyle="#8b8c92",e.fillText(C,k,_),e.textAlign="right",e.fillStyle="#fafafa",e.fillText(b,w,_);g+=d+l}e.restore()}function Ds(e,t,n,i,o,r,a,s,c,l,u){l.length=e.cars.length;for(let p=0;p<e.cars.length;p++){const d=e.cars[p];d!==void 0&&(l[p]=d.id)}l.sort((p,d)=>p-d),u.clear();for(let p=0;p<l.length;p++){const d=l[p];d!==void 0&&u.set(d,p)}c.length=e.cars.length;for(let p=0;p<e.cars.length;p++){const d=e.cars[p];if(d===void 0)continue;const f=d.y,h=d.target!==void 0?s.get(d.target):void 0,g=h!==void 0?e.stops[h]:void 0,m=g?Ls(f,g.y,d.v,o,r,a):void 0,k=u.get(d.id)??0,w=c[p];w===void 0?c[p]={cx:n,cy:t.toScreenAlt(f),altitudeM:f,velocity:d.v,phase:Bn(d.v,i.get(d.id)??0,o),layer:Ln(f),carName:`Climber ${String.fromCharCode(65+k)}`,destinationName:g?.name,etaSeconds:m}:(w.cx=n,w.cy=t.toScreenAlt(f),w.altitudeM=f,w.velocity=d.v,w.phase=Bn(d.v,i.get(d.id)??0,o),w.layer=Ln(f),w.carName=`Climber ${String.fromCharCode(65+k)}`,w.destinationName=g?.name,w.etaSeconds=m)}return c}const _e=[[0,"#1d1a18","#161412"],[12e3,"#161519","#121116"],[5e4,"#0f0f15","#0c0c12"],[8e4,"#0a0a10","#08080d"],[2e5,"#06060a","#040407"]];function Et(e,t,n){return e+(t-e)*n}function It(e,t,n){const i=parseInt(e.slice(1),16),o=parseInt(t.slice(1),16),r=Math.round(Et(i>>16&255,o>>16&255,n)),a=Math.round(Et(i>>8&255,o>>8&255,n)),s=Math.round(Et(i&255,o&255,n));return`#${(r<<16|a<<8|s).toString(16).padStart(6,"0")}`}function Os(e,t){let n=0;for(;n<_e.length-1;n++){const l=_e[n+1];if(l===void 0||e<=l[0])break}const i=_e[n],o=_e[Math.min(n+1,_e.length-1)];if(i===void 0||o===void 0)return"#050810";const r=o[0]-i[0],a=r<=0?0:Math.max(0,Math.min(1,(e-i[0])/r)),s=It(i[1],o[1],a),c=It(i[2],o[2],a);return It(s,c,t)}const Ns=(()=>{const e=[];let t=1333541521;const n=()=>(t=t*1103515245+12345&2147483647,t/2147483647);for(let i=0;i<60;i++){const o=.45+Math.pow(n(),.7)*.55;e.push({altFrac:o,xFrac:n(),size:.3+n()*.9,alpha:.18+n()*.32})}return e})();function Ws(e,t,n,i,o){const r=e.createLinearGradient(0,t.shaftBottom,0,t.shaftTop),a=Math.log10(1+t.axisMaxM/1e3),s=[0,.05,.15,.35,.6,1];for(const l of s){const u=1e3*(10**(l*a)-1);r.addColorStop(l,Os(u,o))}e.fillStyle=r,e.fillRect(n,t.shaftTop,i-n,t.shaftBottom-t.shaftTop),e.save(),e.beginPath(),e.rect(n,t.shaftTop,i-n,t.shaftBottom-t.shaftTop),e.clip();for(const l of Ns){const u=t.axisMaxM*l.altFrac;if(u<8e4)continue;const p=t.toScreenAlt(u),d=n+l.xFrac*(i-n),f=l.alpha*(.7+.3*o);e.fillStyle=`rgba(232, 232, 240, ${f.toFixed(3)})`,e.beginPath(),e.arc(d,p,l.size,0,Math.PI*2),e.fill()}e.restore();const c=Ms(t.axisMaxM);e.font='500 10px system-ui, -apple-system, "Segoe UI", sans-serif',e.textBaseline="middle",e.textAlign="left";for(const l of c){const u=t.toScreenAlt(l.altitudeM);u<t.shaftTop||u>t.shaftBottom||(e.strokeStyle="rgba(200, 220, 255, 0.07)",e.lineWidth=1,e.beginPath(),e.moveTo(n,u),e.lineTo(i,u),e.stroke(),e.fillStyle="rgba(190, 210, 240, 0.30)",e.fillText(l.label,n+4,u-6))}}function qs(e,t,n,i){const r=i-28,a=e.createLinearGradient(0,r,0,i);a.addColorStop(0,"rgba(0,0,0,0)"),a.addColorStop(.6,"rgba(245, 158, 11, 0.06)"),a.addColorStop(1,"rgba(245, 158, 11, 0.10)"),e.fillStyle=a,e.fillRect(t,r,n-t,28),e.strokeStyle=Ue("#f59e0b",.2),e.lineWidth=1,e.beginPath(),e.moveTo(t,i+.5),e.lineTo(n,i+.5),e.stroke()}function Hs(e,t,n){e.strokeStyle="rgba(160, 165, 180, 0.08)",e.lineWidth=3,e.beginPath(),e.moveTo(t,n.shaftTop),e.lineTo(t,n.shaftBottom),e.stroke(),e.strokeStyle="rgba(180, 188, 205, 0.40)",e.lineWidth=1,e.beginPath(),e.moveTo(t,n.shaftTop),e.lineTo(t,n.shaftBottom),e.stroke()}function Gs(e,t,n,i){const o=Math.max(5,i.figureHeadR*2.4);e.save(),e.strokeStyle="rgba(180, 188, 205, 0.18)",e.lineWidth=1,e.setLineDash([2,3]),e.beginPath(),e.moveTo(t,n-18),e.lineTo(t,n-o),e.stroke(),e.setLineDash([]),e.fillStyle="#2a2a35",e.strokeStyle="rgba(180, 188, 205, 0.45)",e.lineWidth=1,e.beginPath();for(let r=0;r<6;r++){const a=-Math.PI/2+r*Math.PI/3,s=t+Math.cos(a)*o,c=n+Math.sin(a)*o;r===0?e.moveTo(s,c):e.lineTo(s,c)}e.closePath(),e.fill(),e.stroke(),e.font=`500 ${(i.fontSmall-1).toFixed(0)}px system-ui, -apple-system, "Segoe UI", sans-serif`,e.fillStyle="rgba(160, 165, 180, 0.65)",e.textAlign="left",e.textBaseline="middle",e.fillText("Counterweight",t+o+6,n),e.restore()}function Us(e,t,n,i,o,r,a){e.font=`${o.fontMain.toFixed(0)}px ui-sans-serif, system-ui, sans-serif`,e.textBaseline="middle";for(const s of t.stops){const c=n.toScreenAlt(s.y);if(c<n.shaftTop||c>n.shaftBottom)continue;const l=36;e.strokeStyle="rgba(220, 230, 245, 0.8)",e.lineWidth=1.6,e.beginPath(),e.moveTo(i-l/2,c),e.lineTo(i-5,c),e.moveTo(i+5,c),e.lineTo(i+l/2,c),e.stroke(),e.strokeStyle="rgba(160, 180, 210, 0.55)",e.lineWidth=1,e.beginPath(),e.moveTo(i-l/2,c),e.lineTo(i-5,c-5),e.moveTo(i+l/2,c),e.lineTo(i+5,c-5),e.stroke(),e.fillStyle="rgba(220, 230, 245, 0.95)",e.textAlign="right",e.fillText(s.name,r+a-4,c-1),e.fillStyle="rgba(160, 178, 210, 0.7)",e.font=`${(o.fontSmall-.5).toFixed(0)}px system-ui, -apple-system, "Segoe UI", sans-serif`,e.fillText(st(s.y),r+a-4,c+10),e.font=`${o.fontMain.toFixed(0)}px ui-sans-serif, system-ui, sans-serif`}}function js(e,t,n){const i=Math.max(n.counterweightAltitudeM,1),o=Math.log10(1+i/1e3);return{axisMaxM:i,shaftTop:e,shaftBottom:t,toScreenAlt:r=>{const a=Math.log10(1+Math.max(0,r)/1e3),s=o<=0?0:Math.max(0,Math.min(1,a/o));return t-s*(t-e)}}}function zs(e,t,n,i,o,r,a){const s=Math.max(2,a.figureHeadR*.9);for(const c of t.cars){if(c.target===void 0)continue;const l=r.get(c.target);if(l===void 0)continue;const u=t.stops[l];if(u===void 0)continue;const p=o.get(c.id);if(p===void 0)continue;const d=n.toScreenAlt(u.y);Math.abs(p-d)<.5||(e.strokeStyle="rgba(250, 250, 250, 0.45)",e.lineWidth=1,e.beginPath(),e.moveTo(i,p),e.lineTo(i,d),e.stroke(),e.fillStyle=Ri,e.beginPath(),e.arc(i,d,s,0,Math.PI*2),e.fill())}}function Vs(e){const n=e%240/240;return(1-Math.cos(n*Math.PI*2))*.5}function Xs(e,t,n,i,o,r,a){a.firstDrawAt===0&&(a.firstDrawAt=performance.now());const s=(performance.now()-a.firstDrawAt)/1e3,c=r.showDayNight?Vs(s):.5,l=n>=520&&i>=360,u=Math.min(120,Math.max(72,n*.16)),p=l?Math.min(220,Math.max(160,n*.24)):0,d=l?14:0,f=o.padX,h=f+u+4,g=n-o.padX-p-d,m=(h+g)/2,k=12,w=o.padTop+24,_=i-o.padBottom-18,y=js(w,_,r);Ws(e,y,h+k,g-k,c),qs(e,h+k,g-k,_),Hs(e,m,y),Gs(e,m,y.shaftTop,o),Us(e,t,y,m,o,f,u);const v=Math.max(20,Math.min(34,g-h-8)),C=Math.max(16,Math.min(26,v*.72));o.carH=C,o.carW=v;const b=a.carCenters,T=a.stopIdxById;b.clear(),T.clear();for(let E=0;E<t.stops.length;E++){const R=t.stops[E];R!==void 0&&T.set(R.entity_id,E)}for(const E of t.cars)b.set(E.id,y.toScreenAlt(E.y));zs(e,t,y,m,b,T,o);for(const E of t.cars){const R=b.get(E.id);R!==void 0&&Bs(e,E,m,R,v,C)}const I=Ds(t,y,m,a.prevVelocity,a.maxSpeed,a.acceleration,a.deceleration,T,a.hudBuf,a.idSortBuf,a.idRankBuf);I.sort((E,R)=>R.altitudeM-E.altitudeM),Fs(e,I,v,n-p-d,o),l&&$s(e,I,n-o.padX-p,p,w,o);for(const E of t.cars)a.prevVelocity.set(E.id,E.v);if(a.prevVelocity.size>t.cars.length)for(const E of a.prevVelocity.keys())b.has(E)||a.prevVelocity.delete(E)}const Ys=1e6;function Mi(e,t){return e*Ys+t}function Ks(e){return{has:(t,n)=>e.has(Mi(t,n))}}function Qs(e){const t=Math.max(0,Math.min(1,(e-320)/580)),n=(i,o)=>i+(o-i)*t;return{padX:n(6,14),padTop:n(22,30),padBottom:n(10,14),labelW:n(52,120),figureGutterW:n(40,70),gutterGap:n(3,5),shaftInnerW:n(28,52),minShaftInnerW:n(22,28),maxShaftInnerW:88,shaftSpacing:n(3,6),carW:n(22,44),carH:n(32,56),fontMain:n(10,12),fontSmall:n(9,10),carDotR:n(1.6,2.2),figureHeadR:n(2,2.8),figureStride:n(5.6,8)}}function Fn(e,t){let n,i=1/0;for(const o of e){const r=Math.abs(o.y-t);r<i&&(i=r,n=o)}return n!==void 0?{stop:n,dist:i}:void 0}function Js(e,t,n){const i=performance.now();for(const o of t){const r=i-o.bornAt;if(r<0)continue;const a=Math.min(1,Math.max(0,r/o.duration)),s=Ii(a),[c,l]=o.kind==="board"?ys(o.startX,o.startY,o.endX,o.endY,s):[o.startX+(o.endX-o.startX)*s,o.startY+(o.endY-o.startY)*s],u=o.kind==="board"?.9:o.kind==="abandon"?(1-s)**1.5:1-s,p=o.kind==="abandon"?n.carDotR*.85:n.carDotR;e.fillStyle=Qt(o.color,u),e.beginPath(),e.arc(c,l,p,0,Math.PI*2),e.fill()}}class Pi{#e;#t;#n=window.devicePixelRatio||1;#o;#r=null;#s=-1;#d=new Map;#a;#i=new Map;#c=new Map;#l=[];#p=null;#m=new Map;#C=new Map;#T=new Map;#R=[];#E=[];#I=new Map;#b=1;#y=1;#S=1;#f=0;#u=new Map;#v=new Map;#A=new Map;#h=new Map;#w=[];#k=new Map;#_=new Set;#x=Ks(this.#_);#M=[];#P=[];#L=[];#B=new Map;#F=new Map;#$=new Map;#D=new Map;#O=[];#N=[];#W=[];#q=new Map;constructor(t,n){this.#e=t;const i=t.getContext("2d");if(!i)throw new Error("2D context unavailable");this.#t=i,this.#a=n,this.#g(),this.#o=()=>{this.#g()},window.addEventListener("resize",this.#o)}dispose(){window.removeEventListener("resize",this.#o)}get canvas(){return this.#e}setTetherConfig(t){this.#p=t,this.#m.clear(),this.#f=0,this.#u.clear()}setTetherPhysics(t,n,i){Number.isFinite(t)&&t>0&&(this.#b=t),Number.isFinite(n)&&n>0&&(this.#y=n),Number.isFinite(i)&&i>0&&(this.#S=i)}pushAssignment(t,n,i){let o=this.#u.get(t);o===void 0&&(o=new Map,this.#u.set(t,o)),o.set(i,n)}#g(){this.#n=window.devicePixelRatio||1;const{clientWidth:t,clientHeight:n}=this.#e;if(t===0||n===0)return;const i=t*this.#n,o=n*this.#n;(this.#e.width!==i||this.#e.height!==o)&&(this.#e.width=i,this.#e.height=o),this.#t.setTransform(this.#n,0,0,this.#n,0,0)}#H(t,n){const i=this.#w.pop();return i!==void 0?(i.start=t,i.end=n,i):{start:t,end:n}}#G(){for(const t of this.#h.values())this.#w.push(t);this.#h.clear()}draw(t,n,i){this.#g();const{clientWidth:o,clientHeight:r}=this.#e,a=this.#t;if(a.clearRect(0,0,o,r),t.stops.length===0||o===0||r===0)return;o!==this.#s&&(this.#r=Qs(o),this.#s=o);const s=this.#r;if(s===null)return;if(this.#p!==null){this.#U(t,o,r,s,n,i,this.#p);return}const c=t.stops.length===2,l=this.#v;l.clear();for(const S of t.cars)l.set(S.id,S);const u=this.#W;u.length=t.stops.length;for(let S=0;S<t.stops.length;S++)u[S]=t.stops[S];u.sort((S,x)=>S.y-x.y);const p=this.#O;p.length=u.length;for(let S=0;S<u.length;S++){const x=u[S];p[S]=x===void 0?0:x.y}const d=t.stops[0];if(d===void 0)return;let f=d.y,h=d.y;for(let S=1;S<t.stops.length;S++){const x=t.stops[S];if(x===void 0)continue;const L=x.y;L<f&&(f=L),L>h&&(h=L)}const g=p.length>=3?(p.at(-1)??0)-(p.at(-2)??0):1,k=f-1,w=h+g,_=Math.max(w-k,1e-4),y=c?18:0;let v,C;if(c)v=s.padTop+y,C=r-s.padBottom-y;else{let S=1/0;for(let Q=1;Q<p.length;Q++){const De=p[Q],Oe=p[Q-1];if(De===void 0||Oe===void 0)continue;const ve=De-Oe;ve>0&&ve<S&&(S=ve)}Number.isFinite(S)||(S=1);const L=48/S,U=Math.max(0,r-s.padTop-s.padBottom)/_,X=Math.min(U,L),ae=_*X;C=r-s.padBottom,v=C-ae}const b=S=>C-(S-k)/_*(C-v),T=this.#d;T.forEach(S=>S.length=0);for(const S of t.cars){const x=T.get(S.line);x?x.push(S):T.set(S.line,[S])}const I=this.#N;I.length=0;for(const S of T.keys())I.push(S);I.sort((S,x)=>S-x);let E=0;for(const S of I)E+=T.get(S)?.length??0;const R=Math.max(0,o-2*s.padX-s.labelW),A=s.figureStride*2,P=s.shaftSpacing*Math.max(E-1,0),O=(R-P)/Math.max(E,1),N=c?34:s.maxShaftInnerW,H=Math.max(s.minShaftInnerW,Math.min(N,O*.55)),ye=Math.max(0,Math.min(O-H,A+s.figureStride*4)),Se=Math.max(14,H-6);let re=1/0;if(t.stops.length>=2)for(let S=1;S<p.length;S++){const x=p[S-1],L=p[S];if(x===void 0||L===void 0)continue;const $=b(x)-b(L);$>0&&$<re&&(re=$)}const zi=b(h)-2,Vi=Number.isFinite(re)?re:s.carH,Xi=c?s.carH:Vi,Yi=Math.max(14,Math.min(Xi,zi));if(!c&&Number.isFinite(re)){const S=Math.max(1.5,Math.min(re*.067,4)),x=s.figureStride*(S/s.figureHeadR);s.figureHeadR=S,s.figureStride=x}s.shaftInnerW=H,s.carW=Se,s.carH=Yi;const Ki=s.padX+s.labelW,Qi=H+ye,$e=this.#M;$e.length=0;const se=this.#A;se.clear(),this.#G();const lt=this.#h;let en=0;for(const S of I){const x=T.get(S)??[];for(const L of x){const $=Ki+en*(Qi+s.shaftSpacing),U=$,X=$+ye,ae=X+H/2;$e.push(ae),se.set(L.id,ae),lt.set(L.id,this.#H(U,X)),en++}}const dt=this.#k;dt.clear();for(let S=0;S<t.stops.length;S++){const x=t.stops[S];x!==void 0&&dt.set(x.entity_id,S)}const tn=this.#_;tn.clear();{let S=0;for(const x of I){const L=T.get(x)??[];for(const $ of L){if($.phase==="loading"||$.phase==="door-opening"||$.phase==="door-closing"){const U=Fn(t.stops,$.y);U!==void 0&&U.dist<.5&&tn.add(Mi(S,U.stop.entity_id))}S++}}}const pt=this.#B,ut=this.#F,ft=this.#$,ht=this.#D;pt.clear(),ut.clear(),ft.clear(),ht.clear();const gt=this.#P;gt.length=0;const mt=this.#L;mt.length=0;let nn=0;for(let S=0;S<I.length;S++){const x=I[S];if(x===void 0)continue;const L=T.get(x)??[],$=Qr[S]??Zr,U=Jr[S]??es,X=ts[S]??1,ae=rs[S]??ss,Q=Math.max(14,H*X),De=Math.max(10,Se*X),Oe=Math.max(10,s.carH),ve=S===2?is:S===3?os:Ct;let Ne=1/0,bt=-1/0,We=1/0;for(const Y of L){pt.set(Y.id,Q),ut.set(Y.id,De),ft.set(Y.id,Oe),ht.set(Y.id,ve);const ce=$e[nn];if(ce===void 0)continue;const on=Number.isFinite(Y.min_served_y)&&Number.isFinite(Y.max_served_y),yt=on?Math.max(v,b(Y.max_served_y)-s.carH-2):v,Ji=on?Math.min(C,b(Y.min_served_y)+2):C;gt.push({cx:ce,top:yt,bottom:Ji,fill:$,frame:U,width:Q}),ce<Ne&&(Ne=ce),ce>bt&&(bt=ce),yt<We&&(We=yt),nn++}I.length>1&&Number.isFinite(Ne)&&Number.isFinite(We)&&mt.push({cx:(Ne+bt)/2,top:We,text:ns[S]??`Line ${S+1}`,color:ae})}hs(a,gt),gs(a,mt,s),ms(a,u,b,s,$e,o,this.#x,v,c),bs(a,t,b,s,lt,this.#u),ws(a,t,se,pt,b,s,dt);for(const S of t.cars){const x=se.get(S.id);if(x===void 0)continue;const L=ut.get(S.id)??s.carW,$=ft.get(S.id)??s.carH,U=ht.get(S.id)??Ct,X=this.#i.get(S.id);ks(a,S,x,L,$,b),_s(a,S,x,L,$,U,b,s,X?.roster)}this.#j(t,se,lt,b,s,n),Js(a,this.#l,s),i&&i.size>0&&As(a,this.#a,l,i,se,b,s,o)}#U(t,n,i,o,r,a,s){const c={prevVelocity:this.#m,maxSpeed:this.#b,acceleration:this.#y,deceleration:this.#S,firstDrawAt:this.#f,carCenters:this.#C,stopIdxById:this.#T,hudBuf:this.#R,idSortBuf:this.#E,idRankBuf:this.#I};Xs(this.#t,t,n,i,o,s,c),this.#f=c.firstDrawAt}#j(t,n,i,o,r,a){const s=performance.now(),c=Math.max(1,a),l=ls/c,u=30/c,p=this.#q;p.clear();for(const d of t.cars){const f=this.#i.get(d.id),h=d.riders,g=n.get(d.id),m=Fn(t.stops,d.y),k=d.phase==="loading"&&m!==void 0&&m.dist<.5?m.stop:void 0;if(f&&g!==void 0&&k!==void 0){const _=h-f.riders;if(_>0&&p.set(k.entity_id,(p.get(k.entity_id)??0)+_),_!==0){const y=o(k.y),v=o(d.y)-r.carH/2,C=Math.min(Math.abs(_),6);if(_>0){const b=k.waiting_up>=k.waiting_down,T=i.get(d.id);let I=g-20;if(T!==void 0){const A=T.start,P=T.end;I=(A+P)/2}const E=b?_i:Ci,R=this.#u.get(k.entity_id);R!==void 0&&(R.delete(d.line),R.size===0&&this.#u.delete(k.entity_id));for(let A=0;A<C;A++)this.#l.push({kind:"board",bornAt:s+A*u,duration:l,startX:I,startY:y,endX:g,endY:v,color:E})}else for(let b=0;b<C;b++)this.#l.push({kind:"alight",bornAt:s+b*u,duration:l,startX:g,startY:v,endX:g+18,endY:v+10,color:Ct})}}let w;if(f){const _=h-f.riders;if(_===0)w=f.roster;else if(w=f.roster.slice(),_>0&&k!==void 0){const v=k.waiting_up>=k.waiting_down?0:1e4;for(let C=0;C<_;C++)w.push(fe(k.entity_id,C+v))}else if(_>0)for(let y=0;y<_;y++)w.push(fe(d.id,w.length+y));else w.splice(w.length+_,-_)}else{w=[];for(let _=0;_<h;_++)w.push(fe(d.id,_))}for(;w.length>h;)w.pop();for(;w.length<h;)w.push(fe(d.id,w.length));this.#i.set(d.id,{riders:h,roster:w})}for(const d of t.stops){const f=d.waiting_up+d.waiting_down,h=this.#c.get(d.entity_id);if(h){const g=h.waiting-f,m=p.get(d.entity_id)??0,k=Math.max(0,g-m);if(k>0){const w=o(d.y),_=r.padX+r.labelW+20,y=Math.min(k,4);for(let v=0;v<y;v++)this.#l.push({kind:"abandon",bornAt:s+v*u,duration:l*1.5,startX:_,startY:w,endX:_-26,endY:w-6,color:Ti})}}this.#c.set(d.entity_id,{waiting:f})}{let d=0;for(let f=0;f<this.#l.length;f++){const h=this.#l[f];h!==void 0&&s-h.bornAt<=h.duration&&(this.#l[d++]=h)}this.#l.length=d}if(this.#i.size>t.cars.length)for(const d of this.#i.keys())this.#v.has(d)||this.#i.delete(d);if(this.#c.size>t.stops.length)for(const d of this.#c.keys())this.#k.has(d)||this.#c.delete(d)}}const Zs="#f59e0b",ea=3;function ta(){const e="quest-pane";return{root:M("quest-pane",e),gridView:M("quest-grid",e),stageView:M("quest-stage-view",e),backBtn:M("quest-back-to-grid",e),title:M("quest-stage-title",e),brief:M("quest-stage-brief",e),stageStars:M("quest-stage-stars",e),editorHost:M("quest-editor",e),runBtn:M("quest-run",e),resetBtn:M("quest-reset",e),result:M("quest-result",e),progress:M("quest-progress",e),shaft:M("quest-shaft",e),shaftIdle:M("quest-shaft-idle",e)}}function At(e,t){e.title.textContent=t.title,e.brief.textContent=t.brief;const n=Fe(t.id);n===0?e.stageStars.textContent="":e.stageStars.textContent="★".repeat(n)+"☆".repeat(ea-n)}function xt(e,t){e.gridView.classList.toggle("hidden",t!=="grid"),e.gridView.classList.toggle("flex",t==="grid"),e.stageView.classList.toggle("hidden",t!=="stage"),e.stageView.classList.toggle("flex",t==="stage")}async function na(e){const t=ta(),n=b=>{const T=Ir(b);if(T)return T;const I=ne[0];if(!I)throw new Error("quest-pane: stage registry is empty");return I},i=qr(n(e.initialStageId),"grid");At(t,i.activeStage);const o=Nr();vn(o,i.activeStage);const r=Wr();kn(r,i.activeStage);const a=Gr();kt(a,i.activeStage);const s=Br(),c=new Pi(t.shaft,Zs);t.runBtn.disabled=!0,t.resetBtn.disabled=!0,t.result.textContent="Loading editor…";const l=await Ho({container:t.editorHost,initialValue:gn(i.activeStage.id)??i.activeStage.starterCode,language:"typescript"});t.runBtn.disabled=!1,t.resetBtn.disabled=!1,t.result.textContent="";const u=Ur(),p=300;let d=null,f=!1;const h=()=>{f||(d!==null&&clearTimeout(d),d=setTimeout(()=>{mn(i.activeStage.id,l.getValue()),d=null},p))},g=()=>{d!==null&&(clearTimeout(d),d=null,mn(i.activeStage.id,l.getValue()))},m=b=>{f=!0;try{l.setValue(b)}finally{f=!1}};l.onDidChange(()=>{h()});const k=Xr();Tn(k,i.activeStage,l);const w=()=>{_n(i),t.shaftIdle.hidden=!1;const b=t.shaft.getContext("2d");b&&b.clearRect(0,0,t.shaft.width,t.shaft.height)},_=(b,{fromGrid:T})=>{g(),Hr(i,b),At(t,b),vn(o,b),kn(r,b),kt(a,b),Tn(k,b,l),m(gn(b.id)??b.starterCode),l.clearRuntimeMarker(),t.result.textContent="",t.progress.textContent="",w(),xt(t,"stage"),wt(i,"stage"),e.onStageChange?.(b.id)},y=()=>{g(),w(),t.result.textContent="",t.progress.textContent="",xt(t,"grid"),wt(i,"grid"),vt(s,b=>{_(n(b),{fromGrid:!0})}),e.onBackToGrid?.()};vt(s,b=>{_(n(b),{fromGrid:!0})});const v=e.landOn??"grid";xt(t,v),wt(i,v);const C=async()=>{const b=i.activeStage;t.runBtn.disabled=!0,t.result.textContent="Running…",t.progress.textContent="",l.clearRuntimeMarker();let T=null,I=0;i.runLoop.active=!0;const E=()=>{i.runLoop.active&&(T!==null&&c.draw(T,1),requestAnimationFrame(E))};t.shaftIdle.hidden=!0,requestAnimationFrame(E);try{const R=await Dr(b,l.getValue(),{timeoutMs:1e3,onProgress:A=>{ke(i,b)&&(t.progress.textContent=Or(A))},onSnapshot:A=>{T=A,I+=1}});if(R.passed){const A=Fe(b.id);R.stars>A&&(Mr(b.id,R.stars),vt(s,P=>{_(n(P),{fromGrid:!0})}),ke(i,b)&&At(t,i.activeStage)),ke(i,b)&&kt(a,i.activeStage,{collapse:!1})}if(ke(i,b)){t.result.textContent="",t.progress.textContent="";const A=R.passed?Ar(b.id):void 0,P=A?()=>{_(A,{fromGrid:!1})}:void 0;jr(u,R,()=>void C(),b.failHint,P)}}catch(R){if(ke(i,b)){const A=R instanceof Error?R.message:String(R);t.result.textContent=`Error: ${A}`,t.progress.textContent="",R instanceof bi&&R.location!==null&&l.setRuntimeMarker({line:R.location.line,column:R.location.column,message:A})}}finally{if(t.runBtn.disabled=!1,_n(i),I===0){const R=t.shaft.getContext("2d");R&&R.clearRect(0,0,t.shaft.width,t.shaft.height),t.shaftIdle.hidden=!1}}};return t.runBtn.addEventListener("click",()=>{C()}),t.resetBtn.addEventListener("click",()=>{window.confirm(`Reset ${i.activeStage.title} to its starter code?`)&&(xr(i.activeStage.id),m(i.activeStage.starterCode),l.clearRuntimeMarker(),t.result.textContent="")}),t.backBtn.addEventListener("click",()=>{y()}),{handles:t,editor:l}}let Mt=null;async function Li(){if(!Mt){const e=new URL("pkg/elevator_wasm.js",document.baseURI).href,t=new URL("pkg/elevator_wasm_bg.wasm",document.baseURI).href;Mt=import(e).then(async n=>(await n.default(t),n))}return Mt}class Jt{#e;#t;constructor(t){this.#e=t,this.#t=t.dt()}static async create(t,n,i){const o=await Li();return new Jt(new o.WasmSim(t,n,i))}step(t){this.#e.stepMany(t)}drainEvents(){return this.#e.drainEvents()}get dt(){return this.#t}tick(){return Number(this.#e.currentTick())}strategyName(){return this.#e.strategyName()}trafficMode(){return this.#e.trafficMode()}setStrategy(t){return this.#e.setStrategy(t)}spawnRider(t,n,i,o){return this.#e.spawnRider(t,n,i,o)}setTrafficRate(t){this.#e.setTrafficRate(t)}trafficRate(){return this.#e.trafficRate()}snapshot(){return this.#e.snapshot()}metrics(){return this.#e.metrics()}waitingCountAt(t){return this.#e.waitingCountAt(t)}applyPhysicsLive(t){try{return this.#e.setMaxSpeedAll(t.maxSpeed),this.#e.setWeightCapacityAll(t.weightCapacityKg),this.#e.setDoorOpenTicksAll(t.doorOpenTicks),this.#e.setDoorTransitionTicksAll(t.doorTransitionTicks),!0}catch{return!1}}dispose(){this.#e.free()}}class Bi{#e;#t=0;#n=[];#o=0;#r=0;#s=1;#d=0;constructor(t){this.#e=ia(BigInt(t>>>0))}setPhases(t){this.#n=t,this.#o=t.reduce((n,i)=>n+i.durationSec,0),this.#r=0,this.#t=0}setIntensity(t){this.#s=Math.max(0,t)}setPatienceTicks(t){this.#d=Math.max(0,Math.floor(t))}drainSpawns(t,n){if(this.#n.length===0)return[];const i=t.stops.filter(s=>s.stop_id!==4294967295);if(i.length<2)return[];const o=Math.min(Math.max(0,n),1),r=this.#n[this.currentPhaseIndex()];if(!r)return[];this.#t+=r.ridersPerMin*this.#s/60*o,this.#r=(this.#r+o)%(this.#o||1);const a=[];for(;this.#t>=1;)this.#t-=1,a.push(this.#a(i,r));return a}currentPhaseIndex(){if(this.#n.length===0)return 0;let t=this.#r;for(const[n,i]of this.#n.entries())if(t-=i.durationSec,t<0)return n;return this.#n.length-1}currentPhaseLabel(){return this.#n[this.currentPhaseIndex()]?.name??""}phaseProgress(){return this.#o<=0?0:Math.min(1,this.#r/this.#o)}progressInPhase(){if(this.#n.length===0)return 0;let t=this.#r;for(const n of this.#n){const i=n.durationSec;if(t<i)return i>0?Math.min(1,t/i):0;t-=i}return 1}phases(){return this.#n}#a(t,n){const i=this.#i(t.length,n.originWeights);let o=this.#i(t.length,n.destWeights);o===i&&(o=(o+1)%t.length);const r=t[i],a=t[o];if(!r||!a)throw new Error("stop index out of bounds");const s=50+this.#p()*50;return{originStopId:r.stop_id,destStopId:a.stop_id,weight:s,...this.#d>0?{patienceTicks:this.#d}:{}}}#i(t,n){if(!n||n.length!==t)return this.#l(t);let i=0;for(const r of n)i+=Math.max(0,r);if(i<=0)return this.#l(t);let o=this.#p()*i;for(const[r,a]of n.entries())if(o-=Math.max(0,a),o<0)return r;return t-1}#c(){let t=this.#e=this.#e+0x9e3779b97f4a7c15n&0xffffffffffffffffn;return t=(t^t>>30n)*0xbf58476d1ce4e5b9n&0xffffffffffffffffn,t=(t^t>>27n)*0x94d049bb133111ebn&0xffffffffffffffffn,t^t>>31n}#l(t){return Number(this.#c()%BigInt(t))}#p(){return Number(this.#c()>>11n)/2**53}}function ia(e){let t=e+0x9e3779b97f4a7c15n&0xffffffffffffffffn;return t=(t^t>>30n)*0xbf58476d1ce4e5b9n&0xffffffffffffffffn,t=(t^t>>27n)*0x94d049bb133111ebn&0xffffffffffffffffn,t^t>>31n}const oa="#7dd3fc",ra="#fda4af";async function $n(e,t,n,i,o){const r=io(i,o),a=await Jt.create(r,t,n),s=new Pi(e.canvas,e.accent);if(s.setTetherConfig(i.tether??null),i.tether){const l=Yt(i,o);s.setTetherPhysics(l.maxSpeed,l.acceleration,l.deceleration)}const c=e.canvas.parentElement;if(c){const l=i.stops.length,p=i.tether?640:Math.max(200,l*16);c.style.setProperty("--shaft-min-h",`${p}px`)}return{strategy:t,sim:a,renderer:s,metricsEl:e.metrics,modeEl:e.mode,metricHistory:{avg_wait_s:[],max_wait_s:[],delivered:[],abandoned:[],utilization:[]},latestMetrics:null,bubbles:new Map}}function Ce(e){e?.sim.dispose(),e?.renderer.dispose()}function Fi(e,t){e.paneA&&t(e.paneA),e.paneB&&t(e.paneB)}const sa=["avg_wait_s","max_wait_s","delivered","abandoned","utilization"],aa=120;function Dn(e,t,n){const i=e.sim.metrics();e.latestMetrics=i;for(const r of sa){const a=e.metricHistory[r];a.push(i[r]),a.length>aa&&a.shift()}const o=performance.now();for(const[r,a]of e.bubbles)a.expiresAt<=o&&e.bubbles.delete(r);e.renderer.draw(t,n,e.bubbles)}const ca={"elevator-assigned":1400,"elevator-arrived":1200,"elevator-repositioning":1600,"door-opened":550,"rider-boarded":850,"rider-exited":1600},la=1e3;function da(e,t,n){const i=performance.now(),o=new Map;for(const a of n.stops)o.set(a.entity_id,a.name);const r=a=>o.get(a)??`stop #${a}`;for(const a of t){const s=pa(a,r);if(s===null)continue;const c=a.elevator;if(c===void 0)continue;const l=ca[a.kind]??la;e.bubbles.set(c,{glyph:s.glyph,text:s.text,bornAt:i,expiresAt:i+l})}}function pa(e,t){switch(e.kind){case"elevator-assigned":return{glyph:"›",text:`To ${t(e.stop)}`};case"elevator-repositioning":return{glyph:"↻",text:`Reposition to ${t(e.stop)}`};case"elevator-arrived":return{glyph:"●",text:`At ${t(e.stop)}`};case"door-opened":return{glyph:"◌",text:"Doors open"};case"rider-boarded":return{glyph:"+",text:"Boarding"};case"rider-exited":return{glyph:"↓",text:`Off at ${t(e.stop)}`};default:return null}}const ua={Idle:"Quiet",UpPeak:"Morning rush",InterFloor:"Mixed",DownPeak:"Evening rush"};function On(e){const t=e.sim.trafficMode();e.modeEl.dataset.mode!==t&&(e.modeEl.dataset.mode=t,e.modeEl.textContent=ua[t],e.modeEl.title=t)}function fa(){const e=s=>{const c=document.getElementById(s);if(!c)throw new Error(`missing element #${s}`);return c},t=s=>document.getElementById(s),n=(s,c)=>({root:e(`pane-${s}`),canvas:e(`shaft-${s}`),name:e(`name-${s}`),mode:e(`mode-${s}`),desc:e(`desc-${s}`),metrics:e(`metrics-${s}`),trigger:e(`strategy-trigger-${s}`),popover:e(`strategy-popover-${s}`),repoTrigger:e(`repo-trigger-${s}`),repoName:e(`repo-name-${s}`),repoPopover:e(`repo-popover-${s}`),accent:c,which:s}),i=s=>{const c=document.querySelector(`.tweak-row[data-key="${s}"]`);if(!c)throw new Error(`missing tweak row for ${s}`);const l=p=>{const d=c.querySelector(p);if(!d)throw new Error(`missing ${p} in tweak row ${s}`);return d},u=p=>c.querySelector(p);return{root:c,value:l(".tweak-value"),defaultV:l(".tweak-default-v"),dec:l(".tweak-dec"),inc:l(".tweak-inc"),reset:l(".tweak-reset"),trackFill:u(".tweak-track-fill"),trackDefault:u(".tweak-track-default"),trackThumb:u(".tweak-track-thumb")}},o={};for(const s of me)o[s]=i(s);const r={scenarioCards:e("scenario-cards"),compareToggle:e("compare"),seedInput:e("seed"),seedShuffleBtn:e("seed-shuffle"),speedInput:e("speed"),speedLabel:e("speed-label"),intensityInput:e("traffic"),intensityLabel:e("traffic-label"),playBtn:e("play"),resetBtn:e("reset"),shareBtn:e("share"),tweakBtn:e("tweak"),tweakPanel:e("tweak-panel"),tweakResetAllBtn:e("tweak-reset-all"),tweakRows:o,layout:e("layout"),loader:e("loader"),toast:e("toast"),phaseStrip:t("phase-strip"),phaseLabel:t("phase-label"),phaseProgress:t("phase-progress-fill"),shortcutsBtn:e("shortcuts"),shortcutSheet:e("shortcut-sheet"),shortcutSheetClose:e("shortcut-sheet-close"),paneA:n("a",oa),paneB:n("b",ra)};Eo(r);const a=document.getElementById("controls-bar");return a&&new ResizeObserver(([c])=>{if(!c)return;const l=Math.ceil(c.borderBoxSize[0]?.blockSize??c.contentRect.height);document.documentElement.style.setProperty("--controls-bar-h",`${l}px`)}).observe(a),r}function $i(e,t,n,i,o,r,a,s,c){const l=document.createDocumentFragment();for(const u of t){const p=document.createElement("button");p.type="button",p.className="strategy-option",p.setAttribute("role","menuitemradio"),p.setAttribute("aria-checked",u===r?"true":"false"),p.dataset[o]=u;const d=document.createElement("span");d.className="strategy-option-name";const f=document.createElement("span");if(f.className="strategy-option-label",f.textContent=n[u],d.appendChild(f),a&&u===a){const g=document.createElement("span");g.className="strategy-option-sibling",g.textContent=`also in ${s}`,d.appendChild(g)}const h=document.createElement("span");h.className="strategy-option-desc",h.textContent=i[u],p.append(d,h),p.addEventListener("click",()=>{c(u)}),l.appendChild(p)}e.replaceChildren(l)}function ie(e,t){const n=Le[t],i=hi[t];e.repoName.textContent!==n&&(e.repoName.textContent=n),e.repoTrigger.setAttribute("aria-label",`Change idle-parking strategy (currently ${n})`),e.repoTrigger.title=i}function Nn(e,t,n,i,o){$i(e.repoPopover,Co,Le,hi,"reposition",t,n,i,o)}function Ie(e,t,n){const{repositionA:i,repositionB:o,compare:r}=e.permalink;Nn(t.paneA,i,r?o:null,"B",a=>void qn(e,t,"a",a,n)),Nn(t.paneB,o,r?i:null,"A",a=>void qn(e,t,"b",a,n))}function Ht(e,t){e.repoPopover.hidden=!t,e.repoTrigger.setAttribute("aria-expanded",String(t))}function Di(e){return!e.paneA.repoPopover.hidden||!e.paneB.repoPopover.hidden}function Gt(e){Ht(e.paneA,!1),Ht(e.paneB,!1)}function at(e){jt(e),Gt(e)}function Wn(e,t,n,i){n.repoTrigger.addEventListener("click",o=>{o.stopPropagation();const r=n.repoPopover.hidden;at(t),r&&(Ie(e,t,i),Ht(n,!0))})}async function qn(e,t,n,i,o){if((n==="a"?e.permalink.repositionA:e.permalink.repositionB)===i){Gt(t);return}n==="a"?(e.permalink={...e.permalink,repositionA:i},ie(t.paneA,i)):(e.permalink={...e.permalink,repositionB:i},ie(t.paneB,i)),W(e.permalink),Ie(e,t,o),Gt(t),await o(),G(t.toast,`${n==="a"?"A":"B"} park: ${Le[i]}`)}function ha(e){document.addEventListener("click",t=>{if(!Oi(e)&&!Di(e))return;const n=t.target;if(n instanceof Node){for(const i of[e.paneA,e.paneB])if(i.popover.contains(n)||i.trigger.contains(n)||i.repoPopover.contains(n)||i.repoTrigger.contains(n))return;at(e)}})}function oe(e,t){const n=ge[t],i=fi[t];e.name.textContent!==n&&(e.name.textContent=n),e.desc.textContent!==i&&(e.desc.textContent=i),e.trigger.setAttribute("aria-label",`Change dispatch strategy (currently ${n})`),e.trigger.title=i}function Hn(e,t,n,i,o){$i(e.popover,_o,ge,fi,"strategy",t,n,i,o)}function Ae(e,t,n){const{strategyA:i,strategyB:o,compare:r}=e.permalink;Hn(t.paneA,i,r?o:null,"B",a=>void Un(e,t,"a",a,n)),Hn(t.paneB,o,r?i:null,"A",a=>void Un(e,t,"b",a,n))}function Ut(e,t){e.popover.hidden=!t,e.trigger.setAttribute("aria-expanded",String(t))}function Oi(e){return!e.paneA.popover.hidden||!e.paneB.popover.hidden}function jt(e){Ut(e.paneA,!1),Ut(e.paneB,!1)}function Gn(e,t,n,i){n.trigger.addEventListener("click",o=>{o.stopPropagation();const r=n.popover.hidden;at(t),r&&(Ae(e,t,i),Ut(n,!0))})}async function Un(e,t,n,i,o){if((n==="a"?e.permalink.strategyA:e.permalink.strategyB)===i){jt(t);return}n==="a"?(e.permalink={...e.permalink,strategyA:i},oe(t.paneA,i)):(e.permalink={...e.permalink,strategyB:i},oe(t.paneB,i)),W(e.permalink),Ae(e,t,o),jt(t),await o(),G(t.toast,`${n==="a"?"A":"B"}: ${ge[i]}`)}function jn(e,t){switch(e){case"cars":case"weightCapacity":return String(Math.round(t));case"maxSpeed":case"doorCycleSec":return t.toFixed(1)}}function ga(e){switch(e){case"cars":return"Cars";case"maxSpeed":return"Max speed";case"weightCapacity":return"Capacity";case"doorCycleSec":return"Door cycle"}}function ct(e,t,n){let i=!1;for(const o of me){const r=n.tweakRows[o],a=e.tweakRanges[o],s=ee(e,o,t),c=Vt(e,o),l=Xt(e,o,s);l&&(i=!0),r.value.textContent=jn(o,s),r.defaultV.textContent=jn(o,c),r.dec.disabled=s<=a.min+1e-9,r.inc.disabled=s>=a.max-1e-9,r.root.dataset.overridden=String(l),r.reset.hidden=!l;const u=Math.max(a.max-a.min,1e-9),p=Math.max(0,Math.min(1,(s-a.min)/u)),d=Math.max(0,Math.min(1,(c-a.min)/u));r.trackFill&&(r.trackFill.style.width=`${(p*100).toFixed(1)}%`),r.trackThumb&&(r.trackThumb.style.left=`${(p*100).toFixed(1)}%`),r.trackDefault&&(r.trackDefault.style.left=`${(d*100).toFixed(1)}%`)}n.tweakResetAllBtn.hidden=!i}function Ni(e,t){e.tweakBtn.setAttribute("aria-expanded",t?"true":"false"),e.tweakPanel.hidden=!t}function Zt(e,t,n,i){const o=Yt(n,e.permalink.overrides),r={maxSpeed:o.maxSpeed,weightCapacityKg:o.weightCapacity,doorOpenTicks:o.doorOpenTicks,doorTransitionTicks:o.doorTransitionTicks},a=[e.paneA,e.paneB].filter(c=>c!==null),s=a.every(c=>c.sim.applyPhysicsLive(r));if(s)for(const c of a)c.renderer?.setTetherPhysics(o.maxSpeed,o.acceleration,o.deceleration);ct(n,e.permalink.overrides,t),s||i()}function ma(e,t,n){return Math.min(n,Math.max(t,e))}function ba(e,t,n){const i=Math.round((e-t)/n);return t+i*n}function Ge(e,t,n,i,o){const r=q(e.permalink.scenario),a=r.tweakRanges[n],s=ee(r,n,e.permalink.overrides),c=ma(s+i*a.step,a.min,a.max),l=ba(c,a.min,a.step);va(e,t,n,l,o)}function ya(e,t,n,i){const o=q(e.permalink.scenario),r={...e.permalink.overrides};Reflect.deleteProperty(r,n),e.permalink={...e.permalink,overrides:r},W(e.permalink),n==="cars"?(i(),G(t.toast,"Cars reset")):(Zt(e,t,o,i),G(t.toast,`${ga(n)} reset`))}async function Sa(e,t,n){const i=q(e.permalink.scenario),o=Xt(i,"cars",ee(i,"cars",e.permalink.overrides));e.permalink={...e.permalink,overrides:{}},W(e.permalink),o?await n():Zt(e,t,i,n),G(t.toast,"Parameters reset")}function va(e,t,n,i,o){const r=q(e.permalink.scenario),a={...e.permalink.overrides,[n]:i};e.permalink={...e.permalink,overrides:ri(r,a)},W(e.permalink),n==="cars"?o():Zt(e,t,r,o)}function wa(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function ka(e){if(Object.prototype.hasOwnProperty.call(e,"__esModule"))return e;var t=e.default;if(typeof t=="function"){var n=function i(){return this instanceof i?Reflect.construct(t,arguments,this.constructor):t.apply(this,arguments)};n.prototype=t.prototype}else n={};return Object.defineProperty(n,"__esModule",{value:!0}),Object.keys(e).forEach(function(i){var o=Object.getOwnPropertyDescriptor(e,i);Object.defineProperty(n,i,o.get?o:{enumerable:!0,get:function(){return e[i]}})}),n}var je={exports:{}},_a=je.exports,zn;function Ca(){return zn||(zn=1,(function(e){(function(t,n,i){function o(c){var l=this,u=s();l.next=function(){var p=2091639*l.s0+l.c*23283064365386963e-26;return l.s0=l.s1,l.s1=l.s2,l.s2=p-(l.c=p|0)},l.c=1,l.s0=u(" "),l.s1=u(" "),l.s2=u(" "),l.s0-=u(c),l.s0<0&&(l.s0+=1),l.s1-=u(c),l.s1<0&&(l.s1+=1),l.s2-=u(c),l.s2<0&&(l.s2+=1),u=null}function r(c,l){return l.c=c.c,l.s0=c.s0,l.s1=c.s1,l.s2=c.s2,l}function a(c,l){var u=new o(c),p=l&&l.state,d=u.next;return d.int32=function(){return u.next()*4294967296|0},d.double=function(){return d()+(d()*2097152|0)*11102230246251565e-32},d.quick=d,p&&(typeof p=="object"&&r(p,u),d.state=function(){return r(u,{})}),d}function s(){var c=4022871197,l=function(u){u=String(u);for(var p=0;p<u.length;p++){c+=u.charCodeAt(p);var d=.02519603282416938*c;c=d>>>0,d-=c,d*=c,c=d>>>0,d-=c,c+=d*4294967296}return(c>>>0)*23283064365386963e-26};return l}n&&n.exports?n.exports=a:this.alea=a})(_a,e)})(je)),je.exports}var ze={exports:{}},Ta=ze.exports,Vn;function Ra(){return Vn||(Vn=1,(function(e){(function(t,n,i){function o(s){var c=this,l="";c.x=0,c.y=0,c.z=0,c.w=0,c.next=function(){var p=c.x^c.x<<11;return c.x=c.y,c.y=c.z,c.z=c.w,c.w^=c.w>>>19^p^p>>>8},s===(s|0)?c.x=s:l+=s;for(var u=0;u<l.length+64;u++)c.x^=l.charCodeAt(u)|0,c.next()}function r(s,c){return c.x=s.x,c.y=s.y,c.z=s.z,c.w=s.w,c}function a(s,c){var l=new o(s),u=c&&c.state,p=function(){return(l.next()>>>0)/4294967296};return p.double=function(){do var d=l.next()>>>11,f=(l.next()>>>0)/4294967296,h=(d+f)/(1<<21);while(h===0);return h},p.int32=l.next,p.quick=p,u&&(typeof u=="object"&&r(u,l),p.state=function(){return r(l,{})}),p}n&&n.exports?n.exports=a:this.xor128=a})(Ta,e)})(ze)),ze.exports}var Ve={exports:{}},Ea=Ve.exports,Xn;function Ia(){return Xn||(Xn=1,(function(e){(function(t,n,i){function o(s){var c=this,l="";c.next=function(){var p=c.x^c.x>>>2;return c.x=c.y,c.y=c.z,c.z=c.w,c.w=c.v,(c.d=c.d+362437|0)+(c.v=c.v^c.v<<4^(p^p<<1))|0},c.x=0,c.y=0,c.z=0,c.w=0,c.v=0,s===(s|0)?c.x=s:l+=s;for(var u=0;u<l.length+64;u++)c.x^=l.charCodeAt(u)|0,u==l.length&&(c.d=c.x<<10^c.x>>>4),c.next()}function r(s,c){return c.x=s.x,c.y=s.y,c.z=s.z,c.w=s.w,c.v=s.v,c.d=s.d,c}function a(s,c){var l=new o(s),u=c&&c.state,p=function(){return(l.next()>>>0)/4294967296};return p.double=function(){do var d=l.next()>>>11,f=(l.next()>>>0)/4294967296,h=(d+f)/(1<<21);while(h===0);return h},p.int32=l.next,p.quick=p,u&&(typeof u=="object"&&r(u,l),p.state=function(){return r(l,{})}),p}n&&n.exports?n.exports=a:this.xorwow=a})(Ea,e)})(Ve)),Ve.exports}var Xe={exports:{}},Aa=Xe.exports,Yn;function xa(){return Yn||(Yn=1,(function(e){(function(t,n,i){function o(s){var c=this;c.next=function(){var u=c.x,p=c.i,d,f;return d=u[p],d^=d>>>7,f=d^d<<24,d=u[p+1&7],f^=d^d>>>10,d=u[p+3&7],f^=d^d>>>3,d=u[p+4&7],f^=d^d<<7,d=u[p+7&7],d=d^d<<13,f^=d^d<<9,u[p]=f,c.i=p+1&7,f};function l(u,p){var d,f=[];if(p===(p|0))f[0]=p;else for(p=""+p,d=0;d<p.length;++d)f[d&7]=f[d&7]<<15^p.charCodeAt(d)+f[d+1&7]<<13;for(;f.length<8;)f.push(0);for(d=0;d<8&&f[d]===0;++d);for(d==8?f[7]=-1:f[d],u.x=f,u.i=0,d=256;d>0;--d)u.next()}l(c,s)}function r(s,c){return c.x=s.x.slice(),c.i=s.i,c}function a(s,c){s==null&&(s=+new Date);var l=new o(s),u=c&&c.state,p=function(){return(l.next()>>>0)/4294967296};return p.double=function(){do var d=l.next()>>>11,f=(l.next()>>>0)/4294967296,h=(d+f)/(1<<21);while(h===0);return h},p.int32=l.next,p.quick=p,u&&(u.x&&r(u,l),p.state=function(){return r(l,{})}),p}n&&n.exports?n.exports=a:this.xorshift7=a})(Aa,e)})(Xe)),Xe.exports}var Ye={exports:{}},Ma=Ye.exports,Kn;function Pa(){return Kn||(Kn=1,(function(e){(function(t,n,i){function o(s){var c=this;c.next=function(){var u=c.w,p=c.X,d=c.i,f,h;return c.w=u=u+1640531527|0,h=p[d+34&127],f=p[d=d+1&127],h^=h<<13,f^=f<<17,h^=h>>>15,f^=f>>>12,h=p[d]=h^f,c.i=d,h+(u^u>>>16)|0};function l(u,p){var d,f,h,g,m,k=[],w=128;for(p===(p|0)?(f=p,p=null):(p=p+"\0",f=0,w=Math.max(w,p.length)),h=0,g=-32;g<w;++g)p&&(f^=p.charCodeAt((g+32)%p.length)),g===0&&(m=f),f^=f<<10,f^=f>>>15,f^=f<<4,f^=f>>>13,g>=0&&(m=m+1640531527|0,d=k[g&127]^=f+m,h=d==0?h+1:0);for(h>=128&&(k[(p&&p.length||0)&127]=-1),h=127,g=512;g>0;--g)f=k[h+34&127],d=k[h=h+1&127],f^=f<<13,d^=d<<17,f^=f>>>15,d^=d>>>12,k[h]=f^d;u.w=m,u.X=k,u.i=h}l(c,s)}function r(s,c){return c.i=s.i,c.w=s.w,c.X=s.X.slice(),c}function a(s,c){s==null&&(s=+new Date);var l=new o(s),u=c&&c.state,p=function(){return(l.next()>>>0)/4294967296};return p.double=function(){do var d=l.next()>>>11,f=(l.next()>>>0)/4294967296,h=(d+f)/(1<<21);while(h===0);return h},p.int32=l.next,p.quick=p,u&&(u.X&&r(u,l),p.state=function(){return r(l,{})}),p}n&&n.exports?n.exports=a:this.xor4096=a})(Ma,e)})(Ye)),Ye.exports}var Ke={exports:{}},La=Ke.exports,Qn;function Ba(){return Qn||(Qn=1,(function(e){(function(t,n,i){function o(s){var c=this,l="";c.next=function(){var p=c.b,d=c.c,f=c.d,h=c.a;return p=p<<25^p>>>7^d,d=d-f|0,f=f<<24^f>>>8^h,h=h-p|0,c.b=p=p<<20^p>>>12^d,c.c=d=d-f|0,c.d=f<<16^d>>>16^h,c.a=h-p|0},c.a=0,c.b=0,c.c=-1640531527,c.d=1367130551,s===Math.floor(s)?(c.a=s/4294967296|0,c.b=s|0):l+=s;for(var u=0;u<l.length+20;u++)c.b^=l.charCodeAt(u)|0,c.next()}function r(s,c){return c.a=s.a,c.b=s.b,c.c=s.c,c.d=s.d,c}function a(s,c){var l=new o(s),u=c&&c.state,p=function(){return(l.next()>>>0)/4294967296};return p.double=function(){do var d=l.next()>>>11,f=(l.next()>>>0)/4294967296,h=(d+f)/(1<<21);while(h===0);return h},p.int32=l.next,p.quick=p,u&&(typeof u=="object"&&r(u,l),p.state=function(){return r(l,{})}),p}n&&n.exports?n.exports=a:this.tychei=a})(La,e)})(Ke)),Ke.exports}var Qe={exports:{}};const Fa={},$a=Object.freeze(Object.defineProperty({__proto__:null,default:Fa},Symbol.toStringTag,{value:"Module"})),Da=ka($a);var Oa=Qe.exports,Jn;function Na(){return Jn||(Jn=1,(function(e){(function(t,n,i){var o=256,r=6,a=52,s="random",c=i.pow(o,r),l=i.pow(2,a),u=l*2,p=o-1,d;function f(y,v,C){var b=[];v=v==!0?{entropy:!0}:v||{};var T=k(m(v.entropy?[y,_(n)]:y??w(),3),b),I=new h(b),E=function(){for(var R=I.g(r),A=c,P=0;R<l;)R=(R+P)*o,A*=o,P=I.g(1);for(;R>=u;)R/=2,A/=2,P>>>=1;return(R+P)/A};return E.int32=function(){return I.g(4)|0},E.quick=function(){return I.g(4)/4294967296},E.double=E,k(_(I.S),n),(v.pass||C||function(R,A,P,D){return D&&(D.S&&g(D,I),R.state=function(){return g(I,{})}),P?(i[s]=R,A):R})(E,T,"global"in v?v.global:this==i,v.state)}function h(y){var v,C=y.length,b=this,T=0,I=b.i=b.j=0,E=b.S=[];for(C||(y=[C++]);T<o;)E[T]=T++;for(T=0;T<o;T++)E[T]=E[I=p&I+y[T%C]+(v=E[T])],E[I]=v;(b.g=function(R){for(var A,P=0,D=b.i,O=b.j,N=b.S;R--;)A=N[D=p&D+1],P=P*o+N[p&(N[D]=N[O=p&O+A])+(N[O]=A)];return b.i=D,b.j=O,P})(o)}function g(y,v){return v.i=y.i,v.j=y.j,v.S=y.S.slice(),v}function m(y,v){var C=[],b=typeof y,T;if(v&&b=="object")for(T in y)try{C.push(m(y[T],v-1))}catch{}return C.length?C:b=="string"?y:y+"\0"}function k(y,v){for(var C=y+"",b,T=0;T<C.length;)v[p&T]=p&(b^=v[p&T]*19)+C.charCodeAt(T++);return _(v)}function w(){try{var y;return d&&(y=d.randomBytes)?y=y(o):(y=new Uint8Array(o),(t.crypto||t.msCrypto).getRandomValues(y)),_(y)}catch{var v=t.navigator,C=v&&v.plugins;return[+new Date,t,C,t.screen,_(n)]}}function _(y){return String.fromCharCode.apply(0,y)}if(k(i.random(),n),e.exports){e.exports=f;try{d=Da}catch{}}else i["seed"+s]=f})(typeof self<"u"?self:Oa,[],Math)})(Qe)),Qe.exports}var Pt,Zn;function Wa(){if(Zn)return Pt;Zn=1;var e=Ca(),t=Ra(),n=Ia(),i=xa(),o=Pa(),r=Ba(),a=Na();return a.alea=e,a.xor128=t,a.xorwow=n,a.xorshift7=i,a.xor4096=o,a.tychei=r,Pt=a,Pt}var qa=Wa();const Ha=wa(qa),it=["ability","able","aboard","about","above","accept","accident","according","account","accurate","acres","across","act","action","active","activity","actual","actually","add","addition","additional","adjective","adult","adventure","advice","affect","afraid","after","afternoon","again","against","age","ago","agree","ahead","aid","air","airplane","alike","alive","all","allow","almost","alone","along","aloud","alphabet","already","also","although","am","among","amount","ancient","angle","angry","animal","announced","another","answer","ants","any","anybody","anyone","anything","anyway","anywhere","apart","apartment","appearance","apple","applied","appropriate","are","area","arm","army","around","arrange","arrangement","arrive","arrow","art","article","as","aside","ask","asleep","at","ate","atmosphere","atom","atomic","attached","attack","attempt","attention","audience","author","automobile","available","average","avoid","aware","away","baby","back","bad","badly","bag","balance","ball","balloon","band","bank","bar","bare","bark","barn","base","baseball","basic","basis","basket","bat","battle","be","bean","bear","beat","beautiful","beauty","became","because","become","becoming","bee","been","before","began","beginning","begun","behavior","behind","being","believed","bell","belong","below","belt","bend","beneath","bent","beside","best","bet","better","between","beyond","bicycle","bigger","biggest","bill","birds","birth","birthday","bit","bite","black","blank","blanket","blew","blind","block","blood","blow","blue","board","boat","body","bone","book","border","born","both","bottle","bottom","bound","bow","bowl","box","boy","brain","branch","brass","brave","bread","break","breakfast","breath","breathe","breathing","breeze","brick","bridge","brief","bright","bring","broad","broke","broken","brother","brought","brown","brush","buffalo","build","building","built","buried","burn","burst","bus","bush","business","busy","but","butter","buy","by","cabin","cage","cake","call","calm","came","camera","camp","can","canal","cannot","cap","capital","captain","captured","car","carbon","card","care","careful","carefully","carried","carry","case","cast","castle","cat","catch","cattle","caught","cause","cave","cell","cent","center","central","century","certain","certainly","chain","chair","chamber","chance","change","changing","chapter","character","characteristic","charge","chart","check","cheese","chemical","chest","chicken","chief","child","children","choice","choose","chose","chosen","church","circle","circus","citizen","city","class","classroom","claws","clay","clean","clear","clearly","climate","climb","clock","close","closely","closer","cloth","clothes","clothing","cloud","club","coach","coal","coast","coat","coffee","cold","collect","college","colony","color","column","combination","combine","come","comfortable","coming","command","common","community","company","compare","compass","complete","completely","complex","composed","composition","compound","concerned","condition","congress","connected","consider","consist","consonant","constantly","construction","contain","continent","continued","contrast","control","conversation","cook","cookies","cool","copper","copy","corn","corner","correct","correctly","cost","cotton","could","count","country","couple","courage","course","court","cover","cow","cowboy","crack","cream","create","creature","crew","crop","cross","crowd","cry","cup","curious","current","curve","customs","cut","cutting","daily","damage","dance","danger","dangerous","dark","darkness","date","daughter","dawn","day","dead","deal","dear","death","decide","declared","deep","deeply","deer","definition","degree","depend","depth","describe","desert","design","desk","detail","determine","develop","development","diagram","diameter","did","die","differ","difference","different","difficult","difficulty","dig","dinner","direct","direction","directly","dirt","dirty","disappear","discover","discovery","discuss","discussion","disease","dish","distance","distant","divide","division","do","doctor","does","dog","doing","doll","dollar","done","donkey","door","dot","double","doubt","down","dozen","draw","drawn","dream","dress","drew","dried","drink","drive","driven","driver","driving","drop","dropped","drove","dry","duck","due","dug","dull","during","dust","duty","each","eager","ear","earlier","early","earn","earth","easier","easily","east","easy","eat","eaten","edge","education","effect","effort","egg","eight","either","electric","electricity","element","elephant","eleven","else","empty","end","enemy","energy","engine","engineer","enjoy","enough","enter","entire","entirely","environment","equal","equally","equator","equipment","escape","especially","essential","establish","even","evening","event","eventually","ever","every","everybody","everyone","everything","everywhere","evidence","exact","exactly","examine","example","excellent","except","exchange","excited","excitement","exciting","exclaimed","exercise","exist","expect","experience","experiment","explain","explanation","explore","express","expression","extra","eye","face","facing","fact","factor","factory","failed","fair","fairly","fall","fallen","familiar","family","famous","far","farm","farmer","farther","fast","fastened","faster","fat","father","favorite","fear","feathers","feature","fed","feed","feel","feet","fell","fellow","felt","fence","few","fewer","field","fierce","fifteen","fifth","fifty","fight","fighting","figure","fill","film","final","finally","find","fine","finest","finger","finish","fire","fireplace","firm","first","fish","five","fix","flag","flame","flat","flew","flies","flight","floating","floor","flow","flower","fly","fog","folks","follow","food","foot","football","for","force","foreign","forest","forget","forgot","forgotten","form","former","fort","forth","forty","forward","fought","found","four","fourth","fox","frame","free","freedom","frequently","fresh","friend","friendly","frighten","frog","from","front","frozen","fruit","fuel","full","fully","fun","function","funny","fur","furniture","further","future","gain","game","garage","garden","gas","gasoline","gate","gather","gave","general","generally","gentle","gently","get","getting","giant","gift","girl","give","given","giving","glad","glass","globe","go","goes","gold","golden","gone","good","goose","got","government","grabbed","grade","gradually","grain","grandfather","grandmother","graph","grass","gravity","gray","great","greater","greatest","greatly","green","grew","ground","group","grow","grown","growth","guard","guess","guide","gulf","gun","habit","had","hair","half","halfway","hall","hand","handle","handsome","hang","happen","happened","happily","happy","harbor","hard","harder","hardly","has","hat","have","having","hay","he","headed","heading","health","heard","hearing","heart","heat","heavy","height","held","hello","help","helpful","her","herd","here","herself","hidden","hide","high","higher","highest","highway","hill","him","himself","his","history","hit","hold","hole","hollow","home","honor","hope","horn","horse","hospital","hot","hour","house","how","however","huge","human","hundred","hung","hungry","hunt","hunter","hurried","hurry","hurt","husband","ice","idea","identity","if","ill","image","imagine","immediately","importance","important","impossible","improve","in","inch","include","including","income","increase","indeed","independent","indicate","individual","industrial","industry","influence","information","inside","instance","instant","instead","instrument","interest","interior","into","introduced","invented","involved","iron","is","island","it","its","itself","jack","jar","jet","job","join","joined","journey","joy","judge","jump","jungle","just","keep","kept","key","kids","kill","kind","kitchen","knew","knife","know","knowledge","known","label","labor","lack","lady","laid","lake","lamp","land","language","large","larger","largest","last","late","later","laugh","law","lay","layers","lead","leader","leaf","learn","least","leather","leave","leaving","led","left","leg","length","lesson","let","letter","level","library","lie","life","lift","light","like","likely","limited","line","lion","lips","liquid","list","listen","little","live","living","load","local","locate","location","log","lonely","long","longer","look","loose","lose","loss","lost","lot","loud","love","lovely","low","lower","luck","lucky","lunch","lungs","lying","machine","machinery","mad","made","magic","magnet","mail","main","mainly","major","make","making","man","managed","manner","manufacturing","many","map","mark","market","married","mass","massage","master","material","mathematics","matter","may","maybe","me","meal","mean","means","meant","measure","meat","medicine","meet","melted","member","memory","men","mental","merely","met","metal","method","mice","middle","might","mighty","mile","military","milk","mill","mind","mine","minerals","minute","mirror","missing","mission","mistake","mix","mixture","model","modern","molecular","moment","money","monkey","month","mood","moon","more","morning","most","mostly","mother","motion","motor","mountain","mouse","mouth","move","movement","movie","moving","mud","muscle","music","musical","must","my","myself","mysterious","nails","name","nation","national","native","natural","naturally","nature","near","nearby","nearer","nearest","nearly","necessary","neck","needed","needle","needs","negative","neighbor","neighborhood","nervous","nest","never","new","news","newspaper","next","nice","night","nine","no","nobody","nodded","noise","none","noon","nor","north","nose","not","note","noted","nothing","notice","noun","now","number","numeral","nuts","object","observe","obtain","occasionally","occur","ocean","of","off","offer","office","officer","official","oil","old","older","oldest","on","once","one","only","onto","open","operation","opinion","opportunity","opposite","or","orange","orbit","order","ordinary","organization","organized","origin","original","other","ought","our","ourselves","out","outer","outline","outside","over","own","owner","oxygen","pack","package","page","paid","pain","paint","pair","palace","pale","pan","paper","paragraph","parallel","parent","park","part","particles","particular","particularly","partly","parts","party","pass","passage","past","path","pattern","pay","peace","pen","pencil","people","per","percent","perfect","perfectly","perhaps","period","person","personal","pet","phrase","physical","piano","pick","picture","pictured","pie","piece","pig","pile","pilot","pine","pink","pipe","pitch","place","plain","plan","plane","planet","planned","planning","plant","plastic","plate","plates","play","pleasant","please","pleasure","plenty","plural","plus","pocket","poem","poet","poetry","point","pole","police","policeman","political","pond","pony","pool","poor","popular","population","porch","port","position","positive","possible","possibly","post","pot","potatoes","pound","pour","powder","power","powerful","practical","practice","prepare","present","president","press","pressure","pretty","prevent","previous","price","pride","primitive","principal","principle","printed","private","prize","probably","problem","process","produce","product","production","program","progress","promised","proper","properly","property","protection","proud","prove","provide","public","pull","pupil","pure","purple","purpose","push","put","putting","quarter","queen","question","quick","quickly","quiet","quietly","quite","rabbit","race","radio","railroad","rain","raise","ran","ranch","range","rapidly","rate","rather","raw","rays","reach","read","reader","ready","real","realize","rear","reason","recall","receive","recent","recently","recognize","record","red","refer","refused","region","regular","related","relationship","religious","remain","remarkable","remember","remove","repeat","replace","replied","report","represent","require","research","respect","rest","result","return","review","rhyme","rhythm","rice","rich","ride","riding","right","ring","rise","rising","river","road","roar","rock","rocket","rocky","rod","roll","roof","room","root","rope","rose","rough","round","route","row","rubbed","rubber","rule","ruler","run","running","rush","sad","saddle","safe","safety","said","sail","sale","salmon","salt","same","sand","sang","sat","satellites","satisfied","save","saved","saw","say","scale","scared","scene","school","science","scientific","scientist","score","screen","sea","search","season","seat","second","secret","section","see","seed","seeing","seems","seen","seldom","select","selection","sell","send","sense","sent","sentence","separate","series","serious","serve","service","sets","setting","settle","settlers","seven","several","shade","shadow","shake","shaking","shall","shallow","shape","share","sharp","she","sheep","sheet","shelf","shells","shelter","shine","shinning","ship","shirt","shoe","shoot","shop","shore","short","shorter","shot","should","shoulder","shout","show","shown","shut","sick","sides","sight","sign","signal","silence","silent","silk","silly","silver","similar","simple","simplest","simply","since","sing","single","sink","sister","sit","sitting","situation","six","size","skill","skin","sky","slabs","slave","sleep","slept","slide","slight","slightly","slip","slipped","slope","slow","slowly","small","smaller","smallest","smell","smile","smoke","smooth","snake","snow","so","soap","social","society","soft","softly","soil","solar","sold","soldier","solid","solution","solve","some","somebody","somehow","someone","something","sometime","somewhere","son","song","soon","sort","sound","source","south","southern","space","speak","special","species","specific","speech","speed","spell","spend","spent","spider","spin","spirit","spite","split","spoken","sport","spread","spring","square","stage","stairs","stand","standard","star","stared","start","state","statement","station","stay","steady","steam","steel","steep","stems","step","stepped","stick","stiff","still","stock","stomach","stone","stood","stop","stopped","store","storm","story","stove","straight","strange","stranger","straw","stream","street","strength","stretch","strike","string","strip","strong","stronger","struck","structure","struggle","stuck","student","studied","studying","subject","substance","success","successful","such","sudden","suddenly","sugar","suggest","suit","sum","summer","sun","sunlight","supper","supply","support","suppose","sure","surface","surprise","surrounded","swam","sweet","swept","swim","swimming","swing","swung","syllable","symbol","system","table","tail","take","taken","tales","talk","tall","tank","tape","task","taste","taught","tax","tea","teach","teacher","team","tears","teeth","telephone","television","tell","temperature","ten","tent","term","terrible","test","than","thank","that","thee","them","themselves","then","theory","there","therefore","these","they","thick","thin","thing","think","third","thirty","this","those","thou","though","thought","thousand","thread","three","threw","throat","through","throughout","throw","thrown","thumb","thus","thy","tide","tie","tight","tightly","till","time","tin","tiny","tip","tired","title","to","tobacco","today","together","told","tomorrow","tone","tongue","tonight","too","took","tool","top","topic","torn","total","touch","toward","tower","town","toy","trace","track","trade","traffic","trail","train","transportation","trap","travel","treated","tree","triangle","tribe","trick","tried","trip","troops","tropical","trouble","truck","trunk","truth","try","tube","tune","turn","twelve","twenty","twice","two","type","typical","uncle","under","underline","understanding","unhappy","union","unit","universe","unknown","unless","until","unusual","up","upon","upper","upward","us","use","useful","using","usual","usually","valley","valuable","value","vapor","variety","various","vast","vegetable","verb","vertical","very","vessels","victory","view","village","visit","visitor","voice","volume","vote","vowel","voyage","wagon","wait","walk","wall","want","war","warm","warn","was","wash","waste","watch","water","wave","way","we","weak","wealth","wear","weather","week","weigh","weight","welcome","well","went","were","west","western","wet","whale","what","whatever","wheat","wheel","when","whenever","where","wherever","whether","which","while","whispered","whistle","white","who","whole","whom","whose","why","wide","widely","wife","wild","will","willing","win","wind","window","wing","winter","wire","wise","wish","with","within","without","wolf","women","won","wonder","wonderful","wood","wooden","wool","word","wore","work","worker","world","worried","worry","worse","worth","would","wrapped","write","writer","writing","written","wrong","wrote","yard","year","yellow","yes","yesterday","yet","you","young","younger","your","yourself","youth","zero","zebra","zipper","zoo","zulu"],Lt=it.reduce((e,t)=>t.length<e.length?t:e).length,Bt=it.reduce((e,t)=>t.length>e.length?t:e).length;function Ga(e){const t=e?.seed?new Ha(e.seed):null,{minLength:n,maxLength:i,...o}=e||{};function r(){let f=typeof n!="number"?Lt:s(n);const h=typeof i!="number"?Bt:s(i);f>h&&(f=h);let g=!1,m;for(;!g;)m=a(),g=m.length<=h&&m.length>=f;return m}function a(){return it[c(it.length)]}function s(f){return f<Lt&&(f=Lt),f>Bt&&(f=Bt),f}function c(f){const h=t?t():Math.random();return Math.floor(h*f)}if(e===void 0)return r();if(typeof e=="number")e={exactly:e};else if(Object.keys(o).length===0)return r();e.exactly&&(e.min=e.exactly,e.max=e.exactly),typeof e.wordsPerString!="number"&&(e.wordsPerString=1),typeof e.formatter!="function"&&(e.formatter=f=>f),typeof e.separator!="string"&&(e.separator=" ");const l=e.min+c(e.max+1-e.min);let u=[],p="",d=0;for(let f=0;f<l*e.wordsPerString;f++)d===e.wordsPerString-1?p+=e.formatter(r(),d):p+=e.formatter(r(),d)+e.separator,d++,(f+1)%e.wordsPerString===0&&(u.push(p),p="",d=0);return typeof e.join=="string"&&(u=u.join(e.join)),u}const Wi=e=>`${e}×`,qi=e=>`${e.toFixed(1)}×`;function Hi(){const e=Ga({exactly:1,minLength:3,maxLength:8});return Array.isArray(e)?e[0]??"seed":e}function Ua(e,t){t.compareToggle.checked=e.compare,t.layout.dataset.mode=e.compare?"compare":"single",t.seedInput.value=e.seed,t.speedInput.value=String(e.speed),t.speedLabel.textContent=Wi(e.speed),t.intensityInput.value=String(e.intensity),t.intensityLabel.textContent=qi(e.intensity),oe(t.paneA,e.strategyA),oe(t.paneB,e.strategyB),ie(t.paneA,e.repositionA),ie(t.paneB,e.repositionB),gi(t,e.scenario);const n=q(e.scenario);Object.keys(e.overrides).length>0&&Ni(t,!0),ct(n,e.overrides,t)}function xe(e,t){const n=!e.shortcutSheet.hidden;t!==n&&(e.shortcutSheet.hidden=!t,t?e.shortcutSheetClose.focus():e.shortcutsBtn.focus())}function Gi(e,t){const n=e.traffic.phases().length>0;t.phaseStrip&&(t.phaseStrip.hidden=!n);const i=t.phaseLabel;if(!i)return;const o=n&&e.traffic.currentPhaseLabel()||"—";i.textContent!==o&&(i.textContent=o)}function Ui(e,t){if(!t.phaseProgress)return;const i=`${Math.round(e.traffic.progressInPhase()*1e3)/10}%`;t.phaseProgress.style.width!==i&&(t.phaseProgress.style.width=i)}function ja(e){if(e.length<2)return{d:"M 0 13 L 100 13",lastX:100,lastY:13};let t=e[0]??0,n=e[0]??0;for(let c=1;c<e.length;c++){const l=e[c];l!==void 0&&(l<t&&(t=l),l>n&&(n=l))}const i=n-t,o=e.length;let r="",a=0,s=7;for(let c=0;c<o;c++){const l=c/(o-1)*100,u=i>0?13-((e[c]??0)-t)/i*12:7;r+=`${c===0?"M":"L"} ${l.toFixed(2)} ${u.toFixed(2)} `,a=l,s=u}return{d:r.trim(),lastX:a,lastY:s}}const Ft="http://www.w3.org/2000/svg",zt=[["wait avg","avg_wait_s"],["wait max","max_wait_s"],["delivered","delivered"],["abandoned","abandoned"],["util","utilization"]];function za(e,t){switch(t){case"avg_wait_s":return`${e.avg_wait_s.toFixed(1)} s`;case"max_wait_s":return`${e.max_wait_s.toFixed(1)} s`;case"delivered":return String(e.delivered);case"abandoned":return String(e.abandoned);case"utilization":return`${(e.utilization*100).toFixed(0)}%`}}function Va(e,t,n){const i=ei(e,n),o=ei(t,n),r=i-o,a=r>0?"▴":"▾",s=r>0?"+":r<0?"−":"",c=Math.abs(r);switch(n){case"avg_wait_s":case"max_wait_s":return`${a} ${s}${c.toFixed(1)} s`;case"delivered":case"abandoned":return`${a} ${s}${c.toFixed(0)}`;case"utilization":return`${a} ${s}${(c*100).toFixed(0)}%`}}function ei(e,t){switch(t){case"avg_wait_s":return e.avg_wait_s;case"max_wait_s":return e.max_wait_s;case"delivered":return e.delivered;case"abandoned":return e.abandoned;case"utilization":return e.utilization}}function Xa(e,t){const n=(f,h,g,m)=>Math.abs(f-h)<g?["tie","tie"]:(m?f>h:f<h)?["win","lose"]:["lose","win"],[i,o]=n(e.avg_wait_s,t.avg_wait_s,.05,!1),[r,a]=n(e.max_wait_s,t.max_wait_s,.05,!1),[s,c]=n(e.delivered,t.delivered,.5,!0),[l,u]=n(e.abandoned,t.abandoned,.5,!1),[p,d]=n(e.utilization,t.utilization,.005,!0);return{a:{avg_wait_s:i,max_wait_s:r,delivered:s,abandoned:l,utilization:p},b:{avg_wait_s:o,max_wait_s:a,delivered:c,abandoned:u,utilization:d}}}function ti(e){const t=document.createDocumentFragment();for(const[n]of zt){const i=Z("div","metric-row"),o=document.createElementNS(Ft,"svg");o.classList.add("metric-spark"),o.setAttribute("viewBox","0 0 100 14"),o.setAttribute("preserveAspectRatio","none"),o.appendChild(document.createElementNS(Ft,"path"));const r=document.createElementNS(Ft,"circle");r.classList.add("metric-spark-dot"),r.setAttribute("r","1.4"),o.appendChild(r),i.append(Z("span","metric-k",n),Z("span","metric-v"),Z("span","metric-d"),o),t.appendChild(i)}e.replaceChildren(t)}function $t(e,t,n,i,o){const r=e.children;for(let a=0;a<zt.length;a++){const s=r[a];if(!s)continue;const c=zt[a];if(!c)continue;const l=c[1],u=n?n[l]:"";s.dataset.verdict!==u&&(s.dataset.verdict=u);const p=s.children[1],d=za(t,l);p.textContent!==d&&(p.textContent=d);const f=s.children[2],g=o!==null&&u!=="tie"&&u!==""?Va(t,o,l):"";f.textContent!==g&&(f.textContent=g);const m=s.children[3],k=m.firstElementChild,w=m.children[1],_=ja(i[l]);k.getAttribute("d")!==_.d&&k.setAttribute("d",_.d);const y=_.lastX.toFixed(2),v=_.lastY.toFixed(2);w.getAttribute("cx")!==y&&w.setAttribute("cx",y),w.getAttribute("cy")!==v&&w.setAttribute("cy",v)}}const Ya=200;function ji(e,t){e.traffic.setPhases(t.phases),e.traffic.setIntensity(e.permalink.intensity),e.traffic.setPatienceTicks(t.abandonAfterSec?Math.round(t.abandonAfterSec*60):0)}async function J(e,t){const n=++e.initToken;t.loader.classList.add("show");const i=q(e.permalink.scenario);e.traffic=new Bi(ui(e.permalink.seed)),ji(e,i),Ce(e.paneA),Ce(e.paneB),e.paneA=null,e.paneB=null;try{const o=await $n(t.paneA,e.permalink.strategyA,e.permalink.repositionA,i,e.permalink.overrides);oe(t.paneA,e.permalink.strategyA),ie(t.paneA,e.permalink.repositionA),ti(t.paneA.metrics);let r=null;if(e.permalink.compare)try{r=await $n(t.paneB,e.permalink.strategyB,e.permalink.repositionB,i,e.permalink.overrides),oe(t.paneB,e.permalink.strategyB),ie(t.paneB,e.permalink.repositionB),ti(t.paneB.metrics)}catch(a){throw Ce(o),a}if(n!==e.initToken){Ce(o),Ce(r);return}e.paneA=o,e.paneB=r,e.seeding=i.seedSpawns>0?{remaining:i.seedSpawns}:null,Gi(e,t),Ui(e,t),ct(i,e.permalink.overrides,t)}catch(o){throw n===e.initToken&&G(t.toast,`Init failed: ${o.message}`),o}finally{n===e.initToken&&t.loader.classList.remove("show")}}function Ka(e){if(!e.seeding||!e.paneA)return;const t=e.paneA.sim.snapshot(),n=4/60;for(let i=0;i<Ya&&e.seeding.remaining>0;i++){const o=e.traffic.drainSpawns(t,n);for(const r of o)if(Fi(e,a=>{const s=a.sim.spawnRider(r.originStopId,r.destStopId,r.weight,r.patienceTicks);s.kind==="err"&&console.warn(`spawnRider failed (seed): ${s.error}`)}),e.seeding.remaining-=1,e.seeding.remaining<=0)break}e.seeding.remaining<=0&&(ji(e,q(e.permalink.scenario)),e.seeding=null)}function Qa(e,t){const n=()=>J(e,t),i={renderPaneStrategyInfo:oe,renderPaneRepositionInfo:ie,refreshStrategyPopovers:()=>{Ae(e,t,n),Ie(e,t,n)},renderTweakPanel:()=>{const r=q(e.permalink.scenario);ct(r,e.permalink.overrides,t)}};t.scenarioCards.addEventListener("click",r=>{const a=r.target;if(!(a instanceof HTMLElement))return;const s=a.closest(".scenario-card");if(!s)return;const c=s.dataset.scenarioId;!c||c===e.permalink.scenario||mi(e,t,c,n,i)}),Gn(e,t,t.paneA,n),Gn(e,t,t.paneB,n),Wn(e,t,t.paneA,n),Wn(e,t,t.paneB,n),Ae(e,t,n),Ie(e,t,n),t.compareToggle.addEventListener("change",()=>{e.permalink={...e.permalink,compare:t.compareToggle.checked},W(e.permalink),t.layout.dataset.mode=e.permalink.compare?"compare":"single",Ae(e,t,n),Ie(e,t,n),J(e,t).then(()=>{G(t.toast,e.permalink.compare?"Compare on":"Compare off")})}),t.seedInput.addEventListener("change",()=>{const r=t.seedInput.value.trim()||F.seed;t.seedInput.value=r,r!==e.permalink.seed&&(e.permalink={...e.permalink,seed:r},W(e.permalink),J(e,t))}),t.seedShuffleBtn.addEventListener("click",()=>{const r=Hi();t.seedInput.value=r,e.permalink={...e.permalink,seed:r},W(e.permalink),J(e,t).then(()=>{G(t.toast,`Seed: ${r}`)})}),t.speedInput.addEventListener("input",()=>{const r=Number(t.speedInput.value);e.permalink.speed=r,t.speedLabel.textContent=Wi(r)}),t.speedInput.addEventListener("change",()=>{W(e.permalink)}),t.intensityInput.addEventListener("input",()=>{const r=Number(t.intensityInput.value);e.permalink.intensity=r,e.traffic.setIntensity(r),t.intensityLabel.textContent=qi(r)}),t.intensityInput.addEventListener("change",()=>{W(e.permalink)});const o=()=>{const r=e.running?"Pause":"Play";t.playBtn.dataset.state=e.running?"running":"paused",t.playBtn.setAttribute("aria-label",r),t.playBtn.title=r};o(),t.playBtn.addEventListener("click",()=>{e.running=!e.running,o()}),t.resetBtn.addEventListener("click",()=>{J(e,t),G(t.toast,"Reset")}),t.tweakBtn.addEventListener("click",()=>{const r=t.tweakBtn.getAttribute("aria-expanded")!=="true";Ni(t,r)});for(const r of me){const a=t.tweakRows[r];sn(a.dec,()=>{Ge(e,t,r,-1,n)}),sn(a.inc,()=>{Ge(e,t,r,1,n)}),a.reset.addEventListener("click",()=>{ya(e,t,r,n)}),a.root.addEventListener("keydown",s=>{s.key==="ArrowUp"||s.key==="ArrowRight"?(s.preventDefault(),Ge(e,t,r,1,n)):(s.key==="ArrowDown"||s.key==="ArrowLeft")&&(s.preventDefault(),Ge(e,t,r,-1,n))})}t.tweakResetAllBtn.addEventListener("click",()=>{Sa(e,t,n)}),t.shareBtn.addEventListener("click",()=>{const r=pi(e.permalink),a=`${window.location.origin}${window.location.pathname}${r}`;window.history.replaceState(null,"",r),navigator.clipboard.writeText(a).then(()=>{G(t.toast,"Permalink copied")},()=>{G(t.toast,"Permalink copied")})}),t.shortcutsBtn.addEventListener("click",()=>{xe(t,t.shortcutSheet.hidden)}),t.shortcutSheetClose.addEventListener("click",()=>{xe(t,!1)}),t.shortcutSheet.addEventListener("click",r=>{r.target===t.shortcutSheet&&xe(t,!1)}),Ja(e,t,i),ha(t)}function Ja(e,t,n){window.addEventListener("keydown",i=>{if(e.permalink.mode==="quest")return;if(i.target instanceof HTMLElement){const r=i.target.tagName;if(r==="INPUT"||r==="TEXTAREA"||r==="SELECT"||i.target.isContentEditable||i.target.closest(".monaco-editor"))return}if(i.metaKey||i.ctrlKey||i.altKey)return;switch(i.key){case" ":{i.preventDefault(),t.playBtn.click();return}case"r":case"R":{i.preventDefault(),t.resetBtn.click();return}case"c":case"C":{i.preventDefault(),t.compareToggle.click();return}case"s":case"S":{i.preventDefault(),t.shareBtn.click();return}case"t":case"T":{i.preventDefault(),t.tweakBtn.click();return}case"?":case"/":{i.preventDefault(),xe(t,t.shortcutSheet.hidden);return}case"Escape":{if(Oi(t)||Di(t)){i.preventDefault(),at(t);return}t.shortcutSheet.hidden||(i.preventDefault(),xe(t,!1));return}}const o=Number(i.key);if(Number.isInteger(o)&&o>=1&&o<=Pe.length){const r=Pe[o-1];if(!r)return;r.id!==e.permalink.scenario&&(i.preventDefault(),mi(e,t,r.id,()=>J(e,t),n))}})}const Za="elevator-core playground",ni="In-browser playground for elevator-core: a deterministic, engine-agnostic Rust simulation library for Bevy, Unity, Godot, and the browser.";function ii(e){eo(ec(e))}function ec(e){if(e.mode==="quest")return{title:`Quest curriculum — ${Za}`,description:"Write a TypeScript dispatch controller and watch it drive the cars. A 15-stage curriculum that teaches the elevator-core API one primitive at a time."};const n=q(e.scenario).label,i=ge[e.strategyA],o=ge[e.strategyB],r=Le[e.repositionA],a=Le[e.repositionB];if(e.compare){const l=`${n}: ${i} vs ${o} — Elevator dispatch playground`,u=`Compare ${i} (parking: ${r}) against ${o} (parking: ${a}) dispatch on the ${n.toLowerCase()} scenario. ${ni}`;return{title:l,description:u}}const s=`${n}: ${i} dispatch — Elevator dispatch playground`,c=`Watch ${i} dispatch (parking: ${r}) handle live rider traffic on the ${n.toLowerCase()} scenario. ${ni}`;return{title:s,description:c}}function oi(e,t){e.sim.step(t);const n=e.sim.drainEvents();if(n.length===0)return null;const i=e.sim.snapshot();da(e,n,i);const o=new Map;for(const r of i.cars)o.set(r.id,r.line);for(const r of n)if(r.kind==="elevator-assigned"){const a=o.get(r.elevator);a!==void 0&&e.renderer.pushAssignment(r.stop,r.elevator,a)}return i}function tc(e){const t=e.paneA;if(!t?.latestMetrics)return;const n=e.paneB;if(n?.latestMetrics){const i=Xa(t.latestMetrics,n.latestMetrics);$t(t.metricsEl,t.latestMetrics,i.a,t.metricHistory,n.latestMetrics),$t(n.metricsEl,n.latestMetrics,i.b,n.metricHistory,t.latestMetrics)}else $t(t.metricsEl,t.latestMetrics,null,t.metricHistory,null);On(t),n&&On(n)}function nc(e,t){let n=0;const i=()=>{const o=performance.now(),r=(o-e.lastFrameTime)/1e3;e.lastFrameTime=o;const a=e.paneA,s=e.paneB,c=a!==null&&(!e.permalink.compare||s!==null);if(e.running&&e.ready&&c){const l=e.permalink.speed;let u=oi(a,l);s&&oi(s,l),e.seeding&&(Ka(e),u=null);const d=Math.min(r,4/60)*l;let f=[];if(!e.seeding){const m=u??a.sim.snapshot();f=e.traffic.drainSpawns(m,d),u=m}for(const m of f)Fi(e,k=>{const w=k.sim.spawnRider(m.originStopId,m.destStopId,m.weight,m.patienceTicks);w.kind==="err"&&console.warn(`spawnRider failed: ${w.error}`)});const h=e.permalink.speed,g=f.length>0||u===null?a.sim.snapshot():u;Dn(a,g,h),s&&Dn(s,s.sim.snapshot(),h),tc(e),(n+=1)%4===0&&(Gi(e,t),Ui(e,t))}requestAnimationFrame(i)};requestAnimationFrame(i)}async function ic(){Li().catch(()=>{});const t=fa(),n=new URLSearchParams(window.location.search).has("k"),i={...F,...wo(window.location.search)};if(!n){i.seed=Hi();const s=new URL(window.location.href);s.searchParams.set("k",i.seed),window.history.replaceState(null,"",s.toString())}Io(i);const o=q(i.scenario),r=new URLSearchParams(window.location.search);o.defaultReposition!==void 0&&(r.has("pa")||(i.repositionA=o.defaultReposition),r.has("pb")||(i.repositionB=o.defaultReposition)),i.overrides=ri(o,i.overrides),Mo(i.mode),Po(i.mode),Ua(i,t);const a={running:!0,ready:!1,permalink:i,paneA:null,paneB:null,traffic:new Bi(ui(i.seed)),lastFrameTime:performance.now(),initToken:0,seeding:null};if(Qa(a,t),So(ii),ii(i),Zi(),await J(a,t),a.ready=!0,nc(a,t),a.permalink.mode==="quest"){const s=new URLSearchParams(window.location.search).has("qs");await na({initialStageId:a.permalink.questStage,landOn:s?"stage":"grid",onStageChange:c=>{a.permalink.questStage=c,W(a.permalink)},onBackToGrid:()=>{a.permalink.questStage=F.questStage,W(a.permalink)}})}}ic();export{et as _};
