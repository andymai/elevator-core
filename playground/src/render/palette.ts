...
// Canvas font stacks — mirror --font-stack-sans / --font-stack-mono in
// style.css. Canvas's `ctx.font` takes a CSS shorthand string but cannot
// read CSS variables, so the stack is duplicated here. Keep in sync.
export const CANVAS_FONT_SANS =
  '"Geist", ui-sans-serif, system-ui, -apple-system, "Segoe UI", sans-serif';
export const CANVAS_FONT_MONO =
